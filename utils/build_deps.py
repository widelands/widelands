...
__USES_INCLUDES['USES_SDL3_IMAGE'] = r'<SDL_image\.h>'
__USES_INCLUDES['USES_SDL3_MIXER'] = r'<SDL_mixer\.h>'
__USES_INCLUDES['USES_SDL3_TTF'] = r'<SDL_ttf\.h>'
__USES_INCLUDES['USES_SDL3'] = r'(?!(<SDL_image\.h>|<SDL_mixer\.h>|<SDL_ttf\.h>))(<SDL.+\.h>)'
