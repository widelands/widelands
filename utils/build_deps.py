...
__USES_INCLUDES['USES_SDL3_IMAGE'] = r'<SDL3_image\/SDL_image\.h>'
__USES_INCLUDES['USES_SDL3_MIXER'] = r'<SDL3_mixer\/SDL_mixer\.h>'
__USES_INCLUDES['USES_SDL3_TTF'] = r'<SDL3_ttf\/SDL_ttf\.h>'
__USES_INCLUDES['USES_SDL3'] = r'(?!(<SDL3_image\/SDL_image\.h>|<SDL3_mixer\/SDL_mixer\.h>|<SDL3_ttf\/SDL_ttf\.h>))(<SDL3\/SDL.+\.h>)'
