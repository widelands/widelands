...
function MakeAppPackage {
   ...
   rm -Rf "${DESTINATION:?empty destination}/"

   mkdir "$DESTINATION/" \
      "$DESTINATION/Widelands.app/" \
      "$DESTINATION/Widelands.app/Contents/" \
      "$DESTINATION/Widelands.app/Contents/Resources/" \
      "$DESTINATION/Widelands.app/Contents/MacOS/"
