...
function building_helptext_note()
	...
	return pgettext("barbarians_building", "The barbarian axfactory is the intermediate production site in a series of three buildings. It is an upgrade from the metal workshop but doesn’t require additional qualification for the worker.")
end
