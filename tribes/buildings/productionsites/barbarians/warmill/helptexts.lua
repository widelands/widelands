...
function building_helptext_note()
	...
	return pgettext("barbarians_building", "The barbarian war mill is their most advanced production site for weapons. As such it needs to be upgraded from an axfactory.")
end
