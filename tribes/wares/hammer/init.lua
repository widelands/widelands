...
tribes:new_ware_type{
   ...
   helptext = {
		...
		-- TRANSLATORS: Helptext for a ware: Hammer
		barbarians = _"Geologists, builders, blacksmiths helmsmiths all need a hammer. Make sure you’ve always have some in reserve! They are one of the basic tools produced at the metal workshop, (but cease to be produced by the building if it is enhanced to an axfactory and war mill).",
		-- TRANSLATORS: Helptext for a ware: Hammer
