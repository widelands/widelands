...
return {
	...
	--Dependencies
		...
		rt(h3(_"Incoming:")) ..
		image_line_dep("tribes/barbarians/tavern/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/oremine/menu.png", p(_"Rations from a Tavern")) ..
		image_line_dep("tribes/barbarians/inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/oremine/menu.png", p(_"Rations from an Inn")) ..
		image_line_dep("tribes/barbarians/big_inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/oremine/menu.png", p(_"Rations from a Big Inn")) ..
		rt(h3(_"Outgoing:")) ..
		image_line_dep("tribes/barbarians/resi_iron2/resi_00.png","tribes/barbarians/oremine/menu.png","tribes/barbarians/ironore/menu.png", p(_"Iron Ore")) ..
	...
	--Building Section
		...
		text_image_line(_"Upgradeable to:",_"Deep Iron Ore Mine","tribes/barbarians/deep_oremine/menu.png") ..
	--Workers Section
		rt(h2(_"Workers")) ..
