...
return {
   func = function(building_description)
	...
	building_help_general_string("barbarians", building_description, "ironore",
		...
		_"This mine exploits only %s of the resource. From there on out, it will only have a 5%% chance of finding any iron ore.":bformat("1/3"), "2") ..
...
--	building_help_outputs("barbarians", building_description, {"smelting_works"}) ..
	...
	--Production Section
		rt(h2(_"Production")) ..
		text_line(_"Performance:", _"If the food supply is steady, this mine can produce iron ore in %s on average.":bformat("65s"))
  end
}
