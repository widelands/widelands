...
return {
	...
	--Lore Section
		rt(h2(_"Lore")) ..
		rt("image=tribes/barbarians/coalmine/coalmine_i_00.png", p(_
	...
	--Dependencies
		...
		rt(h3(_"Incoming:")) ..
		image_line_dep("tribes/barbarians/tavern/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/coalmine/menu.png", p(_"Rations from a Tavern")) ..
		image_line_dep("tribes/barbarians/inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/coalmine/menu.png", p(_"Rations from an Inn")) ..
		image_line_dep("tribes/barbarians/big_inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/coalmine/menu.png", p(_"Rations from a Big Inn")) ..
		rt(h3(_"Outgoing:")) ..
		image_line_dep("tribes/barbarians/resi_coal2/resi_00.png","tribes/barbarians/coalmine/menu.png","tribes/barbarians/coal/menu.png", p(_"Coal")) ..
	...
	--Building Section
		...
		image_line_text("tribes/barbarians/raw_stone/menu.png", 1, p("1 " .. _"Raw Stone")) ..
		image_line_text("tribes/barbarians/trunk/menu.png", 2, p("2 " .. _"Trunk")) ..
		text_image_line(_"Upgradeable to:",_"Deep Coal Mine","tribes/barbarians/deep_coalmine/menu.png") ..
	--Workers Section
		rt(h2(_"Workers")) ..
		rt(h3(_"Crew required:")) ..
		image_line_text("tribes/barbarians/miner/menu.png", 1, p("1 " .. _"Miner" .. _" or better" .. ".")) ..
		text_image_line(_"Worker uses:",_"Pick","tribes/barbarians/pick/menu.png") ..
