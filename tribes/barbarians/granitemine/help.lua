...
return {
	...
	--General Section
		...
		rt(h3(_"Purpose:")) ..
		image_line_text("tribes/barbarians/raw_stone/menu.png", 1, p(_"Carve raw stones out of the rock in mountain terrain.")) ..
	...
	--Dependencies
		...
		rt(h3(_"Incoming:")) ..
		image_line_dep("tribes/barbarians/tavern/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/granitemine/menu.png", p(_"Rations from a Tavern")) ..
		image_line_dep("tribes/barbarians/inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/granitemine/menu.png", p(_"Rations from an Inn")) ..
		image_line_dep("tribes/barbarians/big_inn/menu.png","tribes/barbarians/ration/menu.png","tribes/barbarians/granitemine/menu.png", p(_"Rations from a Big Inn")) ..
		rt(h3(_"Outgoing:")) ..
		image_line_dep("tribes/barbarians/resi_granit2/resi_00.png","tribes/barbarians/granitemine/menu.png","tribes/barbarians/raw_stone/menu.png", p(_"Raw Stone")) ..
		image_line_out("tribes/barbarians/raw_stone/menu.png","tribes/barbarians/constructionsite/construction_i_00.png",p(_"Construction Site")) ..
		image_line_out("tribes/barbarians/raw_stone/menu.png","tribes/barbarians/lime_kiln/menu.png", p(_"Lime Kiln")) ..
	--Building Section
		rt(h2(_"Building")) ..
