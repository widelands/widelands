...
return {
	...
	--General Section
		rt(h2(_"General")) ..
		rt(p(_"Deep Coal Mines exploit only 2/3 of the resource.<br>" .. _"From there on, they will only have a 5% chance of finding coal.")) ..
		rt(h3(_"Purpose:")) ..
	...
	--Dependencies
		...
		rt(h3(_"Incoming:")) ..
		image_line_dep("tribes/barbarians/inn/menu.png","tribes/barbarians/snack/menu.png","tribes/barbarians/deep_coalmine/menu.png", p(_"Snacks from an Inn")) ..
		image_line_dep("tribes/barbarians/big_inn/menu.png","tribes/barbarians/snack/menu.png","tribes/barbarians/deep_coalmine/menu.png", p(_"Snacks from a Big Inn")) ..
		rt(h3(_"Outgoing:")) ..
		image_line_dep("tribes/barbarians/resi_coal2/resi_00.png","tribes/barbarians/deep_coalmine/menu.png","tribes/barbarians/coal/menu.png", p(_"Coal")) ..
	...
	--Building Section
		...
		text_image_line(_"Upgraded from:",_"Coal mine","tribes/barbarians/coalmine/menu.png") ..
		...
		image_line_text("tribes/barbarians/raw_stone/menu.png", 2, p("2 " .. _"Raw Stone")) ..
		image_line_text("tribes/barbarians/trunk/menu.png", 4, p("4 " .. _"Trunk")) ..
		text_image_line(_"Upgradeable to:",_"Deeper Coal Mine","tribes/barbarians/deeper_coalmine/menu.png") ..
	--Workers Section
		rt(h2(_"Workers")) ..
	...
	--Production Section
		rt(h2(_"Production")) ..
		text_line(_"Performance:", _"If the food supply is steady, a Deep Coal Mine can produce one coal in 19.5s on average.")
}