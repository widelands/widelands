...
return {
	...
	--Dependencies
		...
		dependencies({"tribes/barbarians/lumberjacks_hut/menu.png","tribes/barbarians/trunk/menu.png","tribes/barbarians/metalworks/menu.png"}) ..
		rt(p(_"%s from the Lumberjack's hut":format(_"Trunk"))) ..
		rt(h3(_"Outgoing:")) ..
	...
	--Production Section
		rt(h2(_"Production")) ..
		text_line(_"Performance:", _"If all needed wares are delivered in time, a %s can produce each item in about %s on average.":format(_"Metalwork Shop", "67s"))
}
