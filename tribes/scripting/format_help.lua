...
-- TODO(GunChleoc) create descr objects for flag, portdock, ...
	...
	elseif(building_description.type_name == "warehouse") then
		result = result .. rt(h3(_"Healing:")
			.. p(ngettext("Garrisoned soldiers heal %d health per second", "Garrisoned soldiers heal %s health per second", building_description.heal_per_second):bformat(building_description.heal_per_second)))
