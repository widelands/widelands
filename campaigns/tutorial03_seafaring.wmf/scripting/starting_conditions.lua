...
function init_player()
   ...
   {"atlanteans_fish_breeders_house", 40, 66},
   {"atlanteans_fishers_house", 42, 66},
   {"atlanteans_fish_breeders_house", 44, 66},
   {"atlanteans_fishers_house", 46, 66},
   {"atlanteans_fish_breeders_house", 48, 66},
   ...
   {"atlanteans_smelting_works", 35, 56, wares = {coal = 8, ironore = 8}}, -- no gold
   {"atlanteans_smelting_works", 35, 59, wares = {coal = 8, ironore = 8}},
