...
function path_test:test_list_directory()
   ...
   local specific = path.list_directory("/data/pics", "cursor\\.png")
   assert_equal(#specific, 1)
   assert_equal(specific[1], "data/pics/cursor.png")
   local no_slash = path.list_directory("data/pics", "cursor\\.png")
   assert_equal(#no_slash, 1)
   assert_equal(no_slash[1], "data/pics/cursor.png")
end
