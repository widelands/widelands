...
function warehouse_tests:test_get_ware_policy()
   ...
   assert_equal(nil, k.coal)
   k = self.w:get_warehouse_policies("all")
   assert_equal("normal", k.log)
   assert_equal("normal", k.granite)
...
function warehouse_tests:test_set_ware_policy()
   ...
   self.w:set_warehouse_policies("log", "prefer")
   assert_equal(self.w:get_warehouse_policies("log"), "prefer")
   assert_equal(self.w:get_warehouse_policies("granite"), "normal")
   self.w:set_warehouse_policies("log", "dontstock")
   assert_equal(self.w:get_warehouse_policies("log"), "dontstock")
   assert_equal(self.w:get_warehouse_policies("granite"), "normal")
   self.w:set_warehouse_policies("log", "remove")
   assert_equal(self.w:get_warehouse_policies("log"), "remove")
   assert_equal(self.w:get_warehouse_policies("granite"), "normal")
   self.w:set_warehouse_policies("granite", "dontstock")
   assert_equal(self.w:get_warehouse_policies("log"), "remove")
   assert_equal(self.w:get_warehouse_policies("granite"), "dontstock")
   self.w:set_warehouse_policies({"log", "granite"}, "prefer")
   assert_equal(self.w:get_warehouse_policies("log"), "prefer")
   assert_equal(self.w:get_warehouse_policies("granite"), "prefer")
   self.w:set_warehouse_policies("log", "normal")
   self.w:set_warehouse_policies("granite", "normal")
   assert_equal(self.w:get_warehouse_policies("log"), "normal")
   assert_equal(self.w:get_warehouse_policies("granite"), "normal")
   self.w:set_warehouse_policies("all", "prefer")
   assert_equal(self.w:get_warehouse_policies("log"), "prefer")
   assert_equal(self.w:get_warehouse_policies("granite"), "prefer")
...
function warehouse_tests:test_set_worker_policy()
   ...
   self.w:set_warehouse_policies("barbarians_builder", "prefer")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "prefer")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "normal")
   self.w:set_warehouse_policies("barbarians_builder", "dontstock")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "dontstock")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "normal")
   self.w:set_warehouse_policies({"barbarians_builder"}, "remove")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "remove")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "normal")
   self.w:set_warehouse_policies("barbarians_lumberjack", "dontstock")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "remove")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "dontstock")
   self.w:set_warehouse_policies({"barbarians_lumberjack", "barbarians_builder"}, "prefer")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "prefer")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "prefer")
   self.w:set_warehouse_policies("barbarians_builder", "normal")
   self.w:set_warehouse_policies("barbarians_lumberjack", "normal")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "normal")
   assert_equal(self.w:get_warehouse_policies("barbarians_lumberjack"), "normal")
   self.w:set_warehouse_policies("all", "prefer")
   assert_equal(self.w:get_warehouse_policies("barbarians_builder"), "prefer")
...
function warehouse_tests:test_set_ware_and_worker_policy()
   ...
   assert_equal(nil, ret.granite)

   -- Set new policy for workers
   self.w:set_warehouse_policies({"log", "barbarians_builder"}, "remove")
   local ret = self.w:get_warehouse_policies({"log", "barbarians_builder", "barbarians_lumberjack"})
   assert_equal("remove", ret.barbarians_builder)
   assert_equal("normal", ret.barbarians_lumberjack)
   assert_equal("remove", ret.log)

   self.w:set_warehouse_policies({"barbarians_builder"}, "prefer")
   local ret = self.w:get_warehouse_policies({"log", "barbarians_builder", "barbarians_lumberjack"})
   assert_equal("prefer", ret.barbarians_builder)
   assert_equal("normal", ret.barbarians_lumberjack)
   assert_equal("remove", ret.log)

   self.w:set_warehouse_policies("log", "normal")
   ret = self.w:get_warehouse_policies({"log", "barbarians_builder", "barbarians_lumberjack"})
   assert_equal("prefer", ret.barbarians_builder)
   assert_equal("normal", ret.barbarians_lumberjack)
   assert_equal("normal", ret.log)
   assert_equal(nil, ret.granite)

   ret = self.w:get_warehouse_policies("all")
   assert_equal("prefer", ret.barbarians_builder)
   assert_equal("normal", ret.barbarians_lumberjack)
   assert_equal("normal", ret.log)
...
function warehouse_tests:test_set_non_existing_policy()
   ...
   assert_error("invalid policy for ware", function()
      self.w:set_warehouse_policies("log", "burn")
   end)
   assert_error("worker policy for non existing worker", function()
      self.w:set_warehouse_policies("tree_climber", "prefer")
   end)
