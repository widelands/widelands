...
Since pushes generated by bots will not trigger MS-Windows integration checks, it is strongly recommended that you create an API token with push access to your fork, and store it in your fork as a secret called `FORMAT_TOKEN`. See [here](https://docs.github.com/en/actions/configuring-and-managing-workflows/authenticating-with-the-github_token) for more details.
