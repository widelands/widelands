...
const std::vector<Map::OldWorldInfo> Map::kOldWorldNames = {
   ...
   {"summer", "greenland", "world/pics/editor_terrain_category_green.png", []() { return _("Summer"); }},
   /** TRANSLATORS: A world name for the random map generator in the editor */
   {"winter", "winterland", "world/pics/editor_terrain_category_winter.png", []() { return _("Winter"); }},
   /** TRANSLATORS: A world name for the random map generator in the editor */
   {"wasteland", "blackland", "world/pics/editor_terrain_category_wasteland.png", []() { return _("Wasteland"); }},
   /** TRANSLATORS: A world name for the random map generator in the editor */
   {"desert", "desert", "world/pics/editor_terrain_category_desert.png", []() { return _("Desert"); }}};
