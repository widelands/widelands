...
struct BuildingSettings {
	...
	static BuildingSettings* load(const EditorGameBase&,
	                              const TribeDescr&,
	                              FileRead&,
	                              const TribesLegacyLookupTable& tribes_lookup_table);

	virtual void save(const EditorGameBase&, FileWrite&) const;
	virtual void read(const EditorGameBase&, FileRead&, const TribesLegacyLookupTable&);
...
struct ProductionsiteSettings : public BuildingSettings {
	...
	void read(const EditorGameBase&, FileRead&, const TribesLegacyLookupTable& tribes_lookup_table) override;
