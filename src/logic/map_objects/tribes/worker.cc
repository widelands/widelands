...
bool Worker::run_buildferry(Game& game, State& state, const Action& /*unused*/) {
 ...
 */
bool Worker::run_removeobject(Game& game, State& state, const Action& /*unused*/) {
 ...
 * possible.
 */
bool Worker::run_findresources(Game& game, State& state, const Action& /*unused*/) {
...
void Worker::gowarehouse_signalimmediate(Game& /*unused*/,
                                         State& /* state */,
...
void Worker::gowarehouse_pop(Game& /*unused*/, State& /*unused*/) {
	delete supply_;
	supply_ = nullptr;
...
void Worker::dropoff_update(Game& game, State& /*unused*/) {
	std::string signal = get_signal();
...
void Worker::releaserecruit_update(Game& game, State& /*unused*/) {
...
void Worker::waitforcapacity_update(Game& game, State& /*unused*/) {
	std::string signal = get_signal();
