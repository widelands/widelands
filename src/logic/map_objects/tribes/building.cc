...
bool BuildingDescr::suitability(const Map& /*unused*/, const FCoords& fc) const {
...
===============
*/
bool Building::get_building_work(Game& /*unused*/, Worker& worker, bool /*unused*/) {
 ...
 */
void Building::leave_skip(Game& /*unused*/, Worker& w) {
...
void Building::notify_worker_evicted(Game& game, Worker& /*unused*/) {
