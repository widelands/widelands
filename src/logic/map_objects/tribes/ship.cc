 ...
 */
ShipDescr::ShipDescr(const std::string& init_descname, const LuaTable& table, const std::vector<std::string>& attribs)
   : BobDescr(init_descname, MapObjectType::SHIP, MapObjectDescr::OwnerType::kTribe, table, attribs),
