...
struct CheckStepBlocked {
	...
	bool reachable_dest(const Map& /*unused*/, FCoords /*unused*/) const {
		return true;
	}
...
void Bob::move_update(Game& game, State& /*unused*/) {
...
bool Bob::check_node_blocked(Game& game, const FCoords& field, bool /*unused*/) {
