...
BaseImmovable::PositionList Immovable::get_positions(const EditorGameBase& /*unused*/) const {
	PositionList rv;
 ...
 * with any request.
 */
void PlayerImmovable::receive_ware(Game& /*unused*/, DescriptionIndex ware) {
 ...
 */
void PlayerImmovable::receive_worker(Game& /*unused*/, Worker& worker) {
	throw wexception(
