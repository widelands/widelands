...
void Field::set_brightness(int32_t const l,
	...
	static float flatbrightness = MapviewPixelFunctions::calc_brightness(0, 0, 0, 0, 0, 0);

	float b = MapviewPixelFunctions::calc_brightness(l, r, tl, tr, bl, br) - flatbrightness;
