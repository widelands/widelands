...
void ManagementData::initialize( const uint8_t pn, const bool reinitializing) {
    ...
    const std::vector<int16_t> AI_initial_military_numbers_A =
      {  83 ,   43 ,  -38 ,   60 ,   28 ,  -61 ,  -53 ,   40 ,   -9 ,  -10 ,  //AutoContent_01_EForests_
         -9 ,  -94 ,   33 ,   34 ,   40 ,   36 ,  -29 ,  -58 ,   22 ,    7 ,  //AutoContent_02_EForests_
          4 ,   73 ,  -14 ,    0 ,  -53 ,  -25 ,  -62 ,    0 ,  -97 ,   57 ,  //AutoContent_03_EForests_
	...
	const std::vector<int8_t> input_weights_A =
      {   38 ,  -64 ,   34 ,   45 ,   10 ,   -5 ,   15 ,  -24 ,   42 ,  -81 ,  //AutoContent_08_EForests_
         55 ,  -75 ,  -58 ,   -8 ,   35 ,   30 ,   54 ,   55 ,   46 ,   60 ,  //AutoContent_09_EForests_
        -55 ,  -48 ,  -41 ,  -48 ,   57 ,  -51 ,   -1 ,   49 ,   27 ,   37 ,  //AutoContent_10_EForests_
         39 ,  -13 ,   -2 ,   33 ,  -82 ,   14 ,   76 ,  -39 ,   86 ,  -37 ,  //AutoContent_11_EForests_
        -40 ,   47 ,   33 ,   66 ,   72 ,   19 ,  -39 ,   65 ,   59 ,  -50 ,  //AutoContent_12_EForests_
         18 ,   -9 ,    5 ,  -60 ,   64 ,  -48 ,    7 ,   56 ,  -20 ,  -43 ,  //AutoContent_13_EForests_
        -46 ,  -58 ,   78 ,    0 ,   29 ,   36 ,  -69 ,   -9 ,   49 ,  -23 ,  //AutoContent_14_EForests_
        -35 ,   29 ,   35 ,   62 ,  -11 ,    0 ,    0 ,   53 ,  -74 ,   19  //AutoContent_15_EForests_
	}
			;
	const std::vector<int8_t> input_func_A =
      {    2 ,    0 ,    2 ,    2 ,    1 ,    1 ,    2 ,    0 ,    1 ,    2 ,  //AutoContent_16_EForests_
          2 ,    0 ,    2 ,    0 ,    1 ,    1 ,    2 ,    1 ,    1 ,    1 ,  //AutoContent_17_EForests_
          0 ,    1 ,    1 ,    0 ,    1 ,    1 ,    0 ,    2 ,    0 ,    1 ,  //AutoContent_18_EForests_
          2 ,    0 ,    0 ,    0 ,    1 ,    0 ,    1 ,    1 ,    1 ,    1 ,  //AutoContent_19_EForests_
          0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    1 ,    1 ,  //AutoContent_20_EForests_
          2 ,    2 ,    0 ,    2 ,    0 ,    1 ,    2 ,    2 ,    1 ,    0 ,  //AutoContent_21_EForests_
          1 ,    2 ,    0 ,    0 ,    2 ,    0 ,    1 ,    1 ,    0 ,    2 ,  //AutoContent_22_EForests_
          2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    2  //AutoContent_23_EForests_
	}
		;
	...
	const std::vector<uint32_t> f_neurons_A =
      {  1928377746 ,  2903123741 ,  3964867323 ,  2146653879 ,  3382129605 ,  2586070652 ,  1988230621 ,  3233361425 ,  2585204590 ,  1647213901 ,  //AutoContent_24_EForests_
        1075462706 ,  518327319 ,  656300088 ,  903789642 ,  2363339099 ,  148124051 ,  2579251968 ,  811603597 ,  4003677907 ,  461130806 ,  //AutoContent_25_EForests_
        444156012 ,  3780854709 ,  4281866505 ,  601033093 ,  1605571141 ,  65917814 ,  3121446808 ,  3972125297 ,  3356724554 ,  1493183907 ,  //AutoContent_26_EForests_
        2319993135 ,  535108562 ,  4115552720 ,  2847341666 ,  1314894331 ,  152080585 ,  2994344224 ,  4093754829 ,  3054327523 ,  2320852310  //AutoContent_27_EForests_
	 };
	...
	const std::vector<int16_t> AI_initial_military_numbers_B =
      {  83 ,   43 ,  -38 ,   60 ,   28 ,  -61 ,  -53 ,   40 ,   -9 ,  -10 ,  //AutoContent_01_CratEr___
         -9 ,  -94 ,   33 ,   34 ,   40 ,   36 ,  -29 ,  -58 ,   22 ,    7 ,  //AutoContent_02_CratEr___
          4 ,   73 ,  -14 ,    0 ,  -53 ,  -25 ,  -62 ,    0 ,  -97 ,   57 ,  //AutoContent_03_CratEr___
         58 ,   58 ,   35 ,   25 ,    6 ,  -61 ,  -75 ,   26 ,   19 ,   10 ,  //AutoContent_04_CratEr___
         23 ,   -7 ,  -39 ,  -28 ,  -46 ,   49 ,   43 ,  -29 ,   -5 ,   43 ,  //AutoContent_05_CratEr___
          0 ,   10 ,  -42 ,   14 ,  -72 ,   14 ,   38 ,  -63 ,   33 ,  -27 ,  //AutoContent_06_CratEr___
         64 ,   63 ,    0 ,   51 ,  -55 ,   50 ,  -22 ,  -25 ,   27 ,    0  //AutoContent_07_CratEr___
		}
		;
	...
	const std::vector<int8_t> input_weights_B =
      {   38 ,  -64 ,   34 ,   45 ,   10 ,   -5 ,   15 ,  -24 ,   42 ,  -81 ,  //AutoContent_08_CratEr___
        -15 ,  -75 ,  -58 ,   -8 ,   35 ,   30 ,   54 ,   55 ,   46 ,   60 ,  //AutoContent_09_CratEr___
        -55 ,  -48 ,  -41 ,  -48 ,   57 ,  -51 ,   -1 ,   49 ,   27 ,   37 ,  //AutoContent_10_CratEr___
         39 ,  -13 ,   -2 ,   33 ,  -82 ,   14 ,   76 ,  -39 ,   86 ,  -37 ,  //AutoContent_11_CratEr___
        -40 ,   47 ,   33 ,   66 ,   72 ,   19 ,  -39 ,   65 ,   59 ,  -50 ,  //AutoContent_12_CratEr___
         18 ,   -9 ,    5 ,  -60 ,   64 ,  -48 ,    7 ,   56 ,  -20 ,  -43 ,  //AutoContent_13_CratEr___
        -46 ,  -58 ,   78 ,    0 ,   29 ,   36 ,  -69 ,   -9 ,   49 ,  -23 ,  //AutoContent_14_CratEr___
        -35 ,   29 ,   35 ,   62 ,  -11 ,    0 ,    0 ,   53 ,  -74 ,   19  //AutoContent_15_CratEr___
}
	      ;
	
	const std::vector<int8_t> input_func_B = 
      {    2 ,    0 ,    2 ,    2 ,    1 ,    1 ,    2 ,    0 ,    1 ,    2 ,  //AutoContent_16_CratEr___
          1 ,    0 ,    2 ,    0 ,    1 ,    1 ,    2 ,    1 ,    1 ,    1 ,  //AutoContent_17_CratEr___
          0 ,    1 ,    1 ,    0 ,    1 ,    1 ,    0 ,    2 ,    0 ,    1 ,  //AutoContent_18_CratEr___
          2 ,    0 ,    0 ,    0 ,    1 ,    0 ,    1 ,    1 ,    1 ,    1 ,  //AutoContent_19_CratEr___
          0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    1 ,    1 ,  //AutoContent_20_CratEr___
	...
	const std::vector<uint32_t> f_neurons_B =
      {  1928377746 ,  2903123741 ,  3964867323 ,  2146653879 ,  3382129605 ,  2586070652 ,  1988230621 ,  3233361425 ,  2585204590 ,  1647213901 ,  //AutoContent_24_CratEr___
        1075462706 ,  518327319 ,  656300090 ,  903789642 ,  2363339227 ,  148156819 ,  2579251968 ,  811611789 ,  4003677907 ,  461130806 ,  //AutoContent_25_CratEr___
        444156012 ,  3780854709 ,  4281866505 ,  601033093 ,  1605571141 ,  65917814 ,  3121446808 ,  3972125297 ,  3356724554 ,  1493183907 ,  //AutoContent_26_CratEr___
        2319993135 ,  535108562 ,  4115552720 ,  2847341666 ,  1314894331 ,  152080585 ,  2994344224 ,  4093754829 ,  3054327523 ,  2320852310  //AutoContent_27_CratEr___
	 };
	...
	const std::vector<int16_t> AI_initial_military_numbers_C =
      {  83 ,   43 ,  -38 ,   60 ,   28 ,  -61 ,  -53 ,   40 ,   -9 ,  -10 ,  //AutoContent_01_4Mount_
        -39 ,  -94 ,   33 ,   34 ,   40 ,   36 ,  -29 ,  -58 ,   22 ,    7 ,  //AutoContent_02_4Mount_
          4 ,   73 ,  -14 ,    0 ,  -53 ,  -25 ,  -62 ,    0 ,  -97 ,   57 ,  //AutoContent_03_4Mount_
         ...
         64 ,   63 ,    0 ,   51 ,  -55 ,   50 ,  -22 ,  -25 ,   27 ,    0  //AutoContent_07_4Mount_
       }
	...
	const std::vector<int8_t> input_weights_C =
      {   38 ,  -64 ,   34 ,   45 ,   10 ,   -5 ,   15 ,  -24 ,   42 ,  -81 ,  //AutoContent_08_4Mount_
        -15 ,  -75 ,  -58 ,   -8 ,   35 ,   30 ,   54 ,   55 ,   46 ,   60 ,  //AutoContent_09_4Mount_
        -55 ,  -48 ,  -41 ,  -48 ,   57 ,  -51 ,   -1 ,   49 ,   27 ,   37 ,  //AutoContent_10_4Mount_
         39 ,  -13 ,   -2 ,   33 ,  -82 ,   14 ,   76 ,  -39 ,   86 ,  -37 ,  //AutoContent_11_4Mount_
        -40 ,   47 ,   33 ,   66 ,   72 ,   19 ,  -39 ,   65 ,   59 ,  -50 ,  //AutoContent_12_4Mount_
         18 ,   -9 ,    5 ,  -60 ,   64 ,  -48 ,    7 ,   56 ,  -20 ,  -43 ,  //AutoContent_13_4Mount_
        -46 ,  -58 ,   78 ,   83 ,   29 ,   36 ,  -69 ,   -9 ,   49 ,  -23 ,  //AutoContent_14_4Mount_
        -35 ,   29 ,   35 ,   62 ,  -11 ,    0 ,    0 ,   53 ,  -74 ,   19  //AutoContent_15_4Mount_
       }
			;
	const std::vector<int8_t> input_func_C =
      {    2 ,    0 ,    2 ,    2 ,    1 ,    1 ,    2 ,    0 ,    1 ,    2 ,  //AutoContent_16_4Mount_
          1 ,    0 ,    2 ,    0 ,    1 ,    1 ,    2 ,    1 ,    1 ,    1 ,  //AutoContent_17_4Mount_
          0 ,    1 ,    1 ,    0 ,    1 ,    1 ,    0 ,    2 ,    0 ,    1 ,  //AutoContent_18_4Mount_
          2 ,    0 ,    0 ,    0 ,    1 ,    0 ,    1 ,    1 ,    1 ,    1 ,  //AutoContent_19_4Mount_
          0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    1 ,    1 ,  //AutoContent_20_4Mount_
          2 ,    2 ,    0 ,    2 ,    0 ,    1 ,    2 ,    2 ,    1 ,    0 ,  //AutoContent_21_4Mount_
          1 ,    2 ,    0 ,    1 ,    2 ,    0 ,    1 ,    1 ,    0 ,    2 ,  //AutoContent_22_4Mount_
          2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    2  //AutoContent_23_4Mount_
       }
			;
	...
	const std::vector<uint32_t> f_neurons_C =
      {  1928377746 ,  2903123741 ,  3964867323 ,  1609782967 ,  3382129605 ,  2586070652 ,  1988230621 ,  3233394193 ,  2585204590 ,  1647213901 ,  //AutoContent_24_4Mount_
        1075462706 ,  518327319 ,  656300088 ,  903789642 ,  2363339227 ,  148156819 ,  2579251968 ,  811611789 ,  3970647763 ,  461130806 ,  //AutoContent_25_4Mount_
        444156012 ,  3780854709 ,  4281866505 ,  601033093 ,  1605571140 ,  65917814 ,  3121446808 ,  1824641649 ,  3356724554 ,  1493183911 ,  //AutoContent_26_4Mount_
        2319993135 ,  535108562 ,  3041810896 ,  2847340643 ,  1314894319 ,  152080585 ,  2994344224 ,  4093771213 ,  3054327523 ,  2320852310  //AutoContent_27_4Mount_
	 };
	...
	const std::vector<int16_t> AI_initial_military_numbers_D =
      {  83 ,   43 ,  -38 ,   60 ,   28 ,  -61 ,  -53 ,   40 ,   -9 ,  -10 ,  //AutoContent_01_CraBso___
	...
	const std::vector<int8_t> input_weights_D =
      {   38 ,  -64 ,   34 ,   45 ,   10 ,   -5 ,   15 ,  -24 ,   42 ,  -81 ,  //AutoContent_08_CraBso___
        ...
        -35 ,   29 ,   35 ,   62 ,  -11 ,    0 ,    0 ,   53 ,  -74 ,   19  //AutoContent_15_CraBso___
	}
	      ;
	...
	const std::vector<int8_t> input_func_D = 
      {    2 ,    0 ,    2 ,    2 ,    1 ,    1 ,    2 ,    0 ,    1 ,    2 ,  //AutoContent_16_CraBso___
          ...
          2 ,    0 ,    0 ,    0 ,    2 ,    0 ,    0 ,    0 ,    2 ,    2  //AutoContent_23_CraBso___
	}
		;
	...
	const std::vector<uint32_t> f_neurons_D =
      {  1928377746 ,  2903123741 ,  3964867323 ,  1609782967 ,  3382129605 ,  2586070652 ,  1988230621 ,  3233361425 ,  2585204590 ,  1647213901 ,  //AutoContent_24_CraBso___
        3222946354 ,  518327319 ,  655251512 ,  903789642 ,  2363339099 ,  148156819 ,  2579251968 ,  811611789 ,  3970647763 ,  461130806 ,  //AutoContent_25_CraBso___
        444156012 ,  3780854709 ,  4281866505 ,  601033093 ,  1605571141 ,  65917814 ,  3121446808 ,  1824641649 ,  3356724554 ,  1493183911 ,  //AutoContent_26_CraBso___
        2319993135 ,  535108562 ,  3041810896 ,  2847340643 ,  1314894319 ,  152080587 ,  2994344224 ,  4093771213 ,  3054327523 ,  2320852310  //AutoContent_27_CraBso___
	 };
