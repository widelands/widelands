...
void InteractivePlayer::add_statistics_menu() {
	...
	/** TRANSLATORS: An entry in the game's statistics menu */
	statisticsmenu_.add(as_menu_line_with_hotkey(_("Buildings"), "b"), StatisticsMenuEntry::kBuildings, g_gr->images().get("images/wui/menus/menu_building_stats.png"));

	main_windows_.stock.open_window = [this] { new StockMenu(*this, main_windows_.stock); };
	/** TRANSLATORS: An entry in the game's statistics menu */
	statisticsmenu_.add(as_menu_line_with_hotkey(_("Stock"), "i"), StatisticsMenuEntry::kStock, g_gr->images().get("images/wui/menus/menu_stock.png"));
	...
	// if (egbase().map().allows_seafaring()) {
		...
		/** TRANSLATORS: An entry in the game's statistics menu */
		statisticsmenu_.add(as_menu_line_with_hotkey(_("Seafaring"), "e"), StatisticsMenuEntry::kSeafaring, g_gr->images().get("images/wui/buildings/start_expedition.png"));
	// }
