...
std::unique_ptr<UI::HorizontalSlider> AttackBox::add_slider(UI::Box& parent,
	...
	parent.add(result.get(), UI::Align::Align_HCenter);
	return result;
}
...
std::unique_ptr<UI::Button> AttackBox::add_button(UI::Box& parent,
	...
	parent.add(button.get(), UI::Align::Align_HCenter);
	return button;
}
...
void AttackBox::init() {
	...
	add(&linebox, UI::Align::Align_HCenter);
	...
	linebox.add(&columnbox, UI::Align::Align_HCenter);
