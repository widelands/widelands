...
EconomyOptionsWindow::EconomyOptionsWindow(InteractiveGameBase& parent, Economy& economy)
   : UI::UniqueWindow(&parent,
                      "economy_options",
                      &economy.optionswindow_registry(),  // NOCOM
                      0,
                      0,
                      _("Economy options")),
...
std::string EconomyOptionsWindow::TargetWaresDisplay::info_for_ware(
	Widelands::DescriptionIndex const ware) {
...
EconomyOptionsWindow::EconomyOptionsWorkerPanel::EconomyOptionsWorkerPanel(
   UI::Panel* parent, InteractiveGameBase& igbase, Economy& economy)
   : UI::Box(parent, 0, 0, UI::Box::Vertical),
     can_act_(igbase.can_act(economy.owner().player_number())),
