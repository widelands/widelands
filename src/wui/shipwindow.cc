	...
	m_ship(ship)
{
	...
	if (m_ship.state_is_expedition()) {
		...
		exp_top->add(m_btn_scout[WALK_NW - 1], UI::Align::Align_Left, false);
		...
		exp_top->add(m_btn_explore_island_cw, UI::Align::Align_Left, false);
		...
		exp_bot->add(m_btn_scout[WALK_SW - 1], UI::Align::Align_Left, false);
		...
		exp_bot->add(m_btn_explore_island_ccw, UI::Align::Align_Left, false);
		...
		exp_bot->add(m_btn_scout[WALK_SE - 1], UI::Align::Align_Left, false);

	}

	// Bottom buttons
	UI::Box * buttons = new UI::Box(vbox, 0, 0, UI::Box::Horizontal);
	vbox->add(buttons, UI::Align::Align_Left, false);

	m_btn_goto =
		make_button
			(buttons, "goto", _("Go to ship"), pic_goto,
			 boost::bind(&ShipWindow::act_goto, this));
	buttons->add(m_btn_goto, UI::Align::Align_Left, false);
	m_btn_destination =
		make_button
	...
	buttons->add(m_btn_destination, UI::Align::Align_Left, false);

	m_btn_sink =
		make_button
			(buttons, "sink", _("Sink the ship"), pic_sink, boost::bind(&ShipWindow::act_sink, this));
	buttons->add(m_btn_sink, UI::Align::Align_Left, false);
	if (m_ship.state_is_expedition()) {
		...
		buttons->add(m_btn_cancel_expedition, UI::Align::Align_Left, false);
	}
