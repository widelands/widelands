...
:
	...
	exit_game_
		(&box_, "exit_game",
		 ...
		 _("Exit Game"))
{
	box_.add(&readme_, UI::Align::Align_HCenter);
	box_.add(&license_, UI::Align::Align_HCenter);
	box_.add(&authors_, UI::Align::Align_HCenter);
	box_.add_space(vgap);
	box_.add(&sound_, UI::Align::Align_HCenter);
	box_.add_space(vgap);
	box_.add(&save_game_, UI::Align::Align_HCenter);
	box_.add(&exit_game_, UI::Align::Align_HCenter);
