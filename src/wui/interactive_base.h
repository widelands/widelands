...
protected:
	...
	/**
	 * Will blit the 'image' on the given 'pos', offset by 'hotspot' and scaled according to the given zoom 'scale'.
	 * */
	void blit_overlay(RenderTarget* dst, const Vector2i& pos, const Image* image, const Vector2i& hotspot, float scale);
	/**
	 * Will blit the 'image' on the given 'field', offset by 'hotspot' and scaled according to the given zoom 'scale'.
	 * */
