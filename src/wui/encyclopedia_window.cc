						...
						WINDOW_WIDTH / 2 - 1.5 * kPadding, WINDOW_HEIGHT - kTabHeight - 2 * kPadding)
{
	...
	tabs_.add("encyclopedia_wares", g_gr->images().get("images/wui/stats/genstats_nrwares.png"),
				 &wares_tab_box_, _("Wares"));
	tabs_.add("encyclopedia_workers", g_gr->images().get("images/wui/stats/genstats_nrworkers.png"),
				 &workers_tab_box_, _("Workers"));
	tabs_.add("encyclopedia_buildings", g_gr->images().get("images/wui/stats/genstats_nrbuildings.png"),
