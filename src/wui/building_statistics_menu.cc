...
BuildingStatisticsMenu::BuildingStatisticsMenu(InteractivePlayer& parent,
   ...
   : UI::UniqueWindow(&parent,
     ...
     hbox_owned_(&main_box_, UI::PanelStyle::kWui, "owned_hbox", 0, 0, UI::Box::Horizontal, 0, 0, kMargin),
     hbox_construction_(&main_box_, UI::PanelStyle::kWui, "construction_hbox", 0, 0, UI::Box::Horizontal, 0, 0, kMargin),
     hbox_unproductive_(&main_box_, UI::PanelStyle::kWui, "unproductive_hbox", 0, 0, UI::Box::Horizontal, 0, 0, kMargin),

     label_name_(&main_box_,
                 UI::PanelStyle::kWui, "label_name",
                 UI::FontStyle::kWuiLabel,
                 _("(no building selected)"),
                 UI::Align::kCenter),
     label_owned_(&hbox_owned_,
                  UI::PanelStyle::kWui, "label_owned",
                  UI::FontStyle::kWuiLabel,
                  _("Owned:"),
                  UI::Align::kLeft),
     label_construction_(&hbox_construction_,
                         UI::PanelStyle::kWui, "label_construction",
                         UI::FontStyle::kWuiLabel,
                         _("Under construction:"),
                         UI::Align::kLeft),
     label_unproductive_(&hbox_unproductive_,
                         UI::PanelStyle::kWui, "label_unproductive",
                         UI::FontStyle::kWuiLabel,
                         "" /* text will be set later */,
                         UI::Align::kLeft),
     label_nr_owned_(
        &hbox_owned_, UI::PanelStyle::kWui, "owned", UI::FontStyle::kWuiLabel, "", UI::Align::kRight),
     label_nr_construction_(
        &hbox_construction_, UI::PanelStyle::kWui, "construction", UI::FontStyle::kWuiLabel, "", UI::Align::kRight),
     label_nr_unproductive_(
        &hbox_unproductive_, UI::PanelStyle::kWui, "unproductive", UI::FontStyle::kWuiLabel, "", UI::Align::kRight),
     label_threshold_(&main_box_,
                      UI::PanelStyle::kWui, "label_threshold",
                      UI::FontStyle::kWuiLabel,
     ...
     unproductive_threshold_(&main_box_, "unproductive_threshold",
                             0,
                             0,
                             kSpinboxWidth,
                             kSpinboxWidth,
...
void BuildingStatisticsMenu::init(int last_selected_tab) {
	...
	for (int tab_index = 0; tab_index < kNoOfBuildingTabs; ++tab_index) {
		...
		tabs_[tab_index] = new UI::Box(&tab_panel_, UI::PanelStyle::kWui, format("tab_box_%d", tab_index), 0, 0, UI::Box::Vertical);
		UI::Box* row = new UI::Box(tabs_[tab_index], UI::PanelStyle::kWui, format("row_box_%d", tab_index), 0, 0, UI::Box::Horizontal);
		...
		for (const Widelands::DescriptionIndex id : buildings_to_add[tab_index]) {
			...
			if (current_column == 1) {
				...
				row = new UI::Box(tabs_[tab_index], UI::PanelStyle::kWui, format("row_box_%d_%u", tab_index, id), 0, 0, UI::Box::Horizontal);
				current_column = 0;
			}
		}
		// Add final row
...
void BuildingStatisticsMenu::add_button(Widelands::DescriptionIndex id,
                                        const Widelands::BuildingDescr& descr,
                                        UI::Box* row) {
	UI::Box* button_box = new UI::Box(row, UI::PanelStyle::kWui, format("buttons_box_%s", descr.name()), 0, 0, UI::Box::Vertical);
	...
	owned_labels_[id] =
	   new UI::Textarea(button_box, UI::PanelStyle::kWui, format("label_%s", descr.name()), UI::FontStyle::kWuiLabel, 0, 0,
	...
	productivity_labels_[id] =
	   new UI::Textarea(button_box, UI::PanelStyle::kWui, format("productivity_%s", descr.name()), UI::FontStyle::kWuiLabel, 0, 0,
	                    kBuildGridCellWidth, kLabelHeight, "", UI::Align::kCenter);
