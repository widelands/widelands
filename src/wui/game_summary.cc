...
GameSummaryScreen::GameSummaryScreen(InteractiveGameBase* parent, UI::UniqueWindow::Registry* r)
   : UI::UniqueWindow(parent, UI::WindowStyle::kWui, "game_summary", r, 0, 0, _("Game over")),
	...
	// Init boxes
	UI::Box* vbox = new UI::Box(this, UI::PanelStyle::kWui, "vbox", 0, 0, UI::Box::Vertical, 0, 0, kPadding);
	title_area_ = new UI::Textarea(
	   vbox, UI::PanelStyle::kWui, "title", UI::FontStyle::kGameSummaryTitle, "", UI::Align::kCenter);
	...
	players_table_ = new UI::Table<uintptr_t const>(hbox1, "table", 0, 0, 0, 0, UI::PanelStyle::kWui);
	...
	info_area_label_ = new UI::Textarea(
	   info_box_, UI::PanelStyle::kWui, "label_player_info", UI::FontStyle::kWuiLabel, _("Player Info:"));
	...
	widelands_icon_ =
	   new UI::Icon(hbox1, UI::PanelStyle::kWui, "wl_logo", 0, 0, info_area_->get_w(), info_area_->get_h(),
	...
	UI::Box* bottom_box = new UI::Box(vbox, UI::PanelStyle::kWui, "bottom_box", 0, 0, UI::Box::Horizontal);

	bottom_box->add_space(kPadding);

	gametime_label_ = new UI::Textarea(
	   bottom_box, UI::PanelStyle::kWui, "label_elapsed", UI::FontStyle::kWuiLabel, _("Elapsed time:"));
	bottom_box->add(gametime_label_, UI::Box::Resizing::kAlign, UI::Align::kCenter);
	bottom_box->add_space(kPadding);
	gametime_value_ = new UI::Textarea(bottom_box, UI::PanelStyle::kWui, "elapsed", UI::FontStyle::kWuiLabel,
