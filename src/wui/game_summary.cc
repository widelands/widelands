...
GameSummaryScreen::GameSummaryScreen(InteractiveGameBase* parent, UI::UniqueWindow::Registry* r)
   : UI::UniqueWindow(parent, "game_summary", r, 0, 0, _("Game over")),
	...
	vbox->add(title_area_, false, false, UI::Align::kCenter);
	...
	bottom_box->add(gametime_label_, false, false, UI::Align::kCenter);
	bottom_box->add_space(PADDING);
	gametime_value_ = new UI::Textarea(bottom_box, gametimestring(game_.get_gametime()));
	bottom_box->add(gametime_value_, false, false, UI::Align::kCenter);
	...
	bottom_box->add(continue_button_, false, false, UI::Align::kCenter);
	bottom_box->add_space(PADDING);
	...
	bottom_box->add(stop_button_, false, false, UI::Align::kCenter);
	bottom_box->add_space(PADDING);

	vbox->add(bottom_box, true);
	vbox->add_space(PADDING);
