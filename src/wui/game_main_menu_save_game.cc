...
GameMainMenuSaveGame::GameMainMenuSaveGame(InteractiveGameBase& parent,
   ...
   : UI::UniqueWindow(&parent,
     ...
     filename_box_(load_or_save_.table_box(), UI::PanelStyle::kWui, "filename_box", 0, 0, UI::Box::Horizontal),
     filename_label_(&filename_box_,
                     UI::PanelStyle::kWui, "label_filename",
     ...
     buttons_box_(load_or_save_.game_details()->button_box(),
                  UI::PanelStyle::kWui, "buttons_box",
                  0,
                  0,
                  UI::Box::Horizontal),
