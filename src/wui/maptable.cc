...
MapTable::MapTable
	...
	add_column(35, _("Pl."), _("Number of players"), UI::Align::Align_HCenter);
	add_column(get_w() - 35 - 115, "", _("The name of the map or scenario"), UI::Align::Align_Left);
	add_column(115, _("Size"), _("The size of the map (Width x Height)"), UI::Align::Align_Left);
	set_sort_column(0);
}
