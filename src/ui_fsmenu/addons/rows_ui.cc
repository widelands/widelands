...
InstalledAddOnRow::InstalledAddOnRow(Panel* parent,
                                     ...
                                     bool enabled)
   : UI::Panel(parent,
               UI::PanelStyle::kFsMenu, format("installed_addon_row_%s", info->internal_name),
               0,
               0,
               3 * kRowButtonSize,
     ...
     category_(this,
               UI::PanelStyle::kFsMenu, "category",
...
RemoteAddOnRow::RemoteAddOnRow(Panel* parent,
   ...
   : UI::Panel(parent, UI::PanelStyle::kFsMenu, format("remote_addon_row_%s", info->internal_name), 0, 0, 3 * kRowButtonSize, 4 * kRowButtonSize),
     info_(info),
     install_(this,
              "install",
              0,
     ...
     category_(this,
               ...
               g_image_cache->get(AddOns::kAddOnCategories.at(info->category).icon)),
     verified_(this,
               UI::PanelStyle::kFsMenu, "verified",
               g_image_cache->get(info->verified ? "images/ui_basic/list_selected.png" :
                                                   "images/ui_basic/stop.png")),
     quality_(this, UI::PanelStyle::kFsMenu, "quality", AddOnQuality::kQualities.at(info->quality)().icon),
     version_(this,
              UI::PanelStyle::kFsMenu, "version",
              UI::FontStyle::kFsMenuInfoPanelHeading,
              0,
     ...
     bottom_row_left_(this,
                      UI::PanelStyle::kFsMenu, "timestamp",
     ...
     bottom_row_right_(
        this,
        UI::PanelStyle::kFsMenu, "statistics",
        UI::FontStyle::kFsTooltip,
        0,
        0,
        0,
