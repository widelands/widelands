...
void AddOnsCtrl::browse_pagination_changed() {
	...
	const size_t first =
	   browse_pagination_.get_pagesize() * (browse_pagination_.get_current_page() - 1);
...
void AddOnsCtrl::maps_pagination_changed() {
	...
	const size_t first = maps_pagination_.get_pagesize() * (maps_pagination_.get_current_page() - 1);
