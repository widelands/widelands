...
FullscreenMenuInternetLobby::FullscreenMenuInternetLobby(FullscreenMenuMain& fsmm,
   ...
   : FullscreenMenuLoadMapOrGame(fsmm, _("Metaserver Lobby")),
     ...
     // Left column content
     label_clients_online_(&left_column_, UI::PanelStyle::kFsMenu, UI::FontStyle::kFsMenuLabel, 0, 0, 0, 0, _("Clients online:")),
     ...
     label_opengames_(&right_column_, UI::PanelStyle::kFsMenu, UI::FontStyle::kFsMenuLabel, 0, 0, 0, 0, _("Open Games:")),
     ...
     joingame_(&right_column_,
               ...
               _("Join this game")),
     servername_label_(&right_column_, UI::PanelStyle::kFsMenu, UI::FontStyle::kFsMenuLabel, 0, 0, 0, 0, _("Name of your server:")),
