...
FullscreenMenuOptions::FullscreenMenuOptions(FullscreenMenuMain& fsmm,
   ...
   : UI::Window(&fsmm,
                ...
                "options",
                (fsmm.get_w() - fsmm.calc_desired_window_width("options")) / 2,
                (fsmm.get_h() - fsmm.calc_desired_window_height("options")) / 2,
                fsmm.calc_desired_window_width("options"),
                fsmm.calc_desired_window_height("options"),
                _("Options")),
