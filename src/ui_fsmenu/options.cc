...
FullscreenMenuOptions::FullscreenMenuOptions(FullscreenMenuMain& fsmm,
   ...
   : UI::Window(&fsmm,
                ...
                "options",
                (fsmm.get_w() - fsmm.calc_desired_window_width(UI::Window::WindowLayoutID::kFsMenuOptions)) / 2,
                (fsmm.get_h() - fsmm.calc_desired_window_height(UI::Window::WindowLayoutID::kFsMenuOptions)) / 2,
