...
void FullscreenMenuScenarioSelect::layout() {
	...
	scenario_details_.set_size(get_right_column_w(right_column_x_),
	                           tableh_ - buth_ - 6 * padding_ - scenario_difficulty_.get_h() -
	                              scenario_difficulty_header_.get_h());
	scenario_details_.set_desired_size(
	   get_right_column_w(right_column_x_), tableh_ - buth_ - 6 * padding_ -
	                                           scenario_difficulty_.get_h() -
	                                           scenario_difficulty_header_.get_h());
