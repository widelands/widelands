...
void NetSetupLAN::game_selected(uint32_t /*unused*/) {
...
void NetSetupLAN::game_doubleclicked(uint32_t /*unused*/) {
...
void NetSetupLAN::game_closed(const NetOpenGame* /*unused*/) {
}
