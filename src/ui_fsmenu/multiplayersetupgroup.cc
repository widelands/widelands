...
struct MultiPlayerPlayerGroup : public UI::Box {
	MultiPlayerPlayerGroup(UI::Panel* const parent,
	   ...
	   : UI::Box(parent, UI::PanelStyle::kFsMenu, format("multi_player_setup_group_box_%d", id), 0, 0, UI::Box::Horizontal),
	     settings_(settings),
	     n(npsb),
	     id_(id),
	     number_(this,
...
MultiPlayerSetupGroup::MultiPlayerSetupGroup(UI::Panel* const launchgame,
                                             ...
                                             GameSettingsProvider* const settings,
                                             uint32_t buth)
   : UI::Box(parent, UI::PanelStyle::kFsMenu, "multi_player_setup_group", x, y, UI::Box::Horizontal),
     settings_(settings),
     ...
     playerbox_(this, UI::PanelStyle::kFsMenu, "player_box", 0, 0, UI::Box::Vertical, 0, 0, kPadding),
     scrollable_playerbox_(&playerbox_, UI::PanelStyle::kFsMenu, "scrollable_playerbox", 0, 0, UI::Box::Vertical),
     clients_(&clientbox_,
              ...
              UI::Align::kCenter),
     players_(&playerbox_,
              UI::PanelStyle::kFsMenu, "label_players",
              UI::FontStyle::kFsGameSetupHeadings,
              0,
              0,
              0,
