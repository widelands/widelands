...
FullscreenMenuLoadGame::FullscreenMenuLoadGame
	...
	m_title
		(this, get_w() / 2, tabley_ / 3,
		 m_is_replay ? _("Choose a replay") : _("Choose a saved game"), UI::Align::Align_HCenter),

	// Savegame description
	m_label_mapname
		(this, right_column_x_, tabley_, "", UI::Align::Align_Left),
	m_ta_mapname(this,
	...
	m_label_version
		(this, right_column_x_, get_y_from_preceding(m_ta_players),
		 ...
		 UI::Align::Align_Left),
	m_ta_version(this,
					 m_right_column_tab, m_label_version.get_y(), "", UI::Align::Align_Left),
	...
	m_ctrl(gc)
{
	...
	m_table.add_column(130, _("Save Date"), _("The date this game was saved"), UI::Align::Align_Left);
	int used_width = 130;
