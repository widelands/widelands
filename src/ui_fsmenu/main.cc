...
MainMenu::MainMenu(const bool skip_init)
   : UI::Panel(nullptr, UI::PanelStyle::kFsMenu, "widelands_main_menu", 0, 0, g_gr->get_xres(), g_gr->get_yres()),
     box_rect_(0, 0, 0, 0),
     butw_(get_w() * 7 / 20),
     buth_(get_h() * 9 / 200),
     padding_(buth_ / 3),
     ...
     version_(this,
              ...
              UI::Align::kCenter),
     copyright_(this,
                UI::PanelStyle::kFsMenu, "copyright",
                UI::FontStyle::kFsMenuInfoPanelParagraph,
                0,
                0,
                0,
