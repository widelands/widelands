...
SinglePlayerActivePlayerGroup::SinglePlayerActivePlayerGroup(UI::Panel* const parent,
   ...
   : UI::Box(parent, UI::PanelStyle::kFsMenu, format("single_player_active_player_group_box_%d", id), 0, 0, UI::Box::Horizontal),
     id_(id),
     settings_(settings),
     number_(this,
             "number",
...
SinglePlayerSetupBox::SinglePlayerSetupBox(UI::Panel* const parent,
   ...
   : UI::Box(parent, UI::PanelStyle::kFsMenu, "single_player_setup_box", 0, 0, UI::Box::Vertical),
     ...
     scrollable_playerbox_(this, UI::PanelStyle::kFsMenu, "scrollable_player_box", 0, 0, UI::Box::Vertical),
     title_(this,
