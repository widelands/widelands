   ...
   : UI::Window(parent,
	...
	main_box_.add(
	   new UI::Textarea(&main_box_, UI::PanelStyle::kWui, "label_statistics",
	                    UI::FontStyle::kWuiLabel, _("Fleet Statistics"), UI::Align::kCenter),
	   UI::Box::Resizing::kFullSize);

	UI::Box* columns_box =
	   new UI::Box(&main_box_, UI::PanelStyle::kWui, "columns_box", 0, 0, UI::Box::Horizontal);
	UI::Box* column1 =
	   new UI::Box(columns_box, UI::PanelStyle::kWui, "column_box_1", 0, 0, UI::Box::Vertical);
	UI::Box* column2 =
	...
	auto create_textarea = [column1, column2, rtl](UI::Textarea** txt, std::string label) {
		...
		column1->add(new UI::Textarea(column1, UI::PanelStyle::kWui, "label",
		             ...
		             UI::Box::Resizing::kFullSize);
		*txt = new UI::Textarea(column2, UI::PanelStyle::kWui, "value",
