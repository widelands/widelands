...
#include "ui/basic/infinite_spinner.h"
...
ActionConfirm::ActionConfirm(InteractivePlayer& parent,
   ...
   : UI::Window(
	...
	UI::Button* okbtn =
	   new UI::Button(button_box, "ok", 0, 0, 80, default_button_size(), UI::ButtonStyle::kWuiMenu,
	                  g_image_cache->get("images/wui/menu_okay.png"));
	okbtn->sigclicked.connect([this]() { ok(); });

	UI::Button* cancelbtn =
	   new UI::Button(button_box, "abort", 0, 0, 80, default_button_size(),
	                  UI::ButtonStyle::kWuiMenu, g_image_cache->get("images/wui/menu_abort.png"));
