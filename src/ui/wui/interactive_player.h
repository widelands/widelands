...
#ifndef WL_UI_WUI_INTERACTIVE_PLAYER_H
#define WL_UI_WUI_INTERACTIVE_PLAYER_H
...
public:
	...
	void notify_message(Widelands::PlayerNumber pn,
...
#endif  // end of include guard: WL_UI_WUI_INTERACTIVE_PLAYER_H
