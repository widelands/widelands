...
AddOnsLoginBox::AddOnsLoginBox(UI::Panel& parent, UI::WindowStyle style)
   : UI::Window(&parent, style, "login", 0, 0, default_panel_dimension_narrow(), default_panel_dimension_narrow(), _("Login")),
     ...
     username_(&right_box_, "username", 0, 0, default_panel_dimension_large(), panel_style_),
     password_(&right_box_, "password", 0, 0, default_panel_dimension_large(), panel_style_),
     ok_(&buttons_box_,
         "ok",
         0,
         0,
