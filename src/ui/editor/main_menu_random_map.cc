...
MainMenuNewRandomMapPanel::MainMenuNewRandomMapPanel(UI::Panel& parent,
   ...
   : UI::Box(&parent,
     ...
     wasteland_(this,
                ...
                5),
     mountains_box_(
        this, panel_style_, "mountains_box", 0, 0, UI::Box::Horizontal, 0, 0, default_padding()),
     ...
     map_number_and_id_vbox_1_(&map_number_and_id_hbox_,
                               panel_style_,
                               "id_vbox1",
                               0,
                               0,
                               ...
                               0,
                               default_padding()),
     map_number_and_id_vbox_2_(&map_number_and_id_hbox_,
                               panel_style_,
                               "id_vbox2",
                               0,
                               0,
...
MainMenuNewRandomMap::MainMenuNewRandomMap(UI::Panel& parent,
   ...
   : UI::UniqueWindow(
     ...
     button_box_(
        &box_, panel_style_, "buttons_box", 0, 0, UI::Box::Horizontal, 0, 0, default_padding()),
