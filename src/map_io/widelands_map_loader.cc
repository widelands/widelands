...
int32_t WidelandsMapLoader::load_map_complete(EditorGameBase& egbase,
	...
	if (fs_->file_exists("port_spaces")) {
		log_info_time(egbase.get_gametime(), "Reading Port Spaces Data ... ");
	...
	log_info_time(egbase.get_gametime(), "Reading Heights Data ... ");
	...
	log_info_time(egbase.get_gametime(), "Reading Terrain Data ... ");
	...
	log_info_time(egbase.get_gametime(), "Reading Map Objects ... ");
	set_progress_message(_("Map objects"), 4);
	mapobjects.read(*fs_, egbase, *mol_, *world_lookup_table, *tribes_lookup_table);
	log_info_time(egbase.get_gametime(), "took %ums\n ", timer.ms_since_last_query());

	log_info_time(egbase.get_gametime(), "Reading Player Start Position Data ... ");
	...
	if (fs_->file_exists("binary/bob")) {
		log_info_time(egbase.get_gametime(), "Reading (legacy) Bob Data ... ");
		{
			MapBobPacket p;
	...
	log_info_time(egbase.get_gametime(), "Reading Resources Data ... ");
	...
	if (!is_editor) {
		log_info_time(egbase.get_gametime(), "Reading Map Version Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Allowed Worker Types Data ... ");
		{
		...
		log_info_time(egbase.get_gametime(), "Reading Allowed Building Types Data ... ");
		{
		...
		log_info_time(egbase.get_gametime(), "Reading Node Ownership Data ... ");
		{
		...
		//  EXISTENT PACKETS
		log_info_time(egbase.get_gametime(), "Reading Flag Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Road Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Waterway Data ... ");
		{
			MapWaterwayPacket p;
			p.read(*fs_, egbase, is_game, *mol_);
		}
		...
		log_info_time(egbase.get_gametime(), "Reading Building Data ... ");
		...
		//  DATA PACKETS
		log_info_time(egbase.get_gametime(), "Reading Flagdata Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Roaddata Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Waterwaydata Data ... ");
		{
		...
		log_info_time(egbase.get_gametime(), "Reading Buildingdata Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Second and third phase loading Map Objects ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Players View Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Player Message Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Wincondition Data ... ");
		...
		log_info_time(egbase.get_gametime(), "Reading Objective Data ... ");
	...
	log_info_time(egbase.get_gametime(), "Reading Scripting Data ... ");
	...
	log_info_time(egbase.get_gametime(), "Reading map images ... ");
