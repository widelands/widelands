...
private:
	...
	virtual void read_headquarters
		(Headquarters           &, FileRead  &, Game &, Map_Map_Object_Loader &);
	...
	virtual void write_headquarters
		(const Headquarters     &, FileWrite &, Game &, Map_Map_Object_Saver  &);
