...
#ifndef WL_COMMANDS_CMD_SET_WARE_TARGET_QUANTITY_H
#define WL_COMMANDS_CMD_SET_WARE_TARGET_QUANTITY_H
...
#endif  // end of include guard: WL_COMMANDS_CMD_SET_WARE_TARGET_QUANTITY_H
