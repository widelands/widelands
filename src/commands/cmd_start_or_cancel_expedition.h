...
#ifndef WL_COMMANDS_CMD_START_OR_CANCEL_EXPEDITION_H
#define WL_COMMANDS_CMD_START_OR_CANCEL_EXPEDITION_H
...
#endif  // end of include guard: WL_COMMANDS_CMD_START_OR_CANCEL_EXPEDITION_H
