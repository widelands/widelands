...
#ifndef WL_COMMANDS_CMD_SHIP_SCOUT_DIRECTION_H
#define WL_COMMANDS_CMD_SHIP_SCOUT_DIRECTION_H
...
#endif  // end of include guard: WL_COMMANDS_CMD_SHIP_SCOUT_DIRECTION_H
