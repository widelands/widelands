...
#ifndef WL_COMMANDS_CMD_CALCULATE_STATISTICS_H
#define WL_COMMANDS_CMD_CALCULATE_STATISTICS_H
...
#endif  // end of include guard: WL_COMMANDS_CMD_CALCULATE_STATISTICS_H
