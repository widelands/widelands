...
inline bool compare(const T1 a,
                    const T2 b) {  // NOLINT false-positive readability-avoid-const-params-in-decls
	return a == b;
}
template <typename T>
inline bool compare(const char* a,
                    const T b) {  // NOLINT false-positive readability-avoid-const-params-in-decls
	return std::string(a) == b;
}
template <typename T>
inline bool compare(char* a,
                    const T b) {  // NOLINT false-positive readability-avoid-const-params-in-decls
	return std::string(a) == b;
}
inline bool compare(const unsigned a,
...
template <typename T>
inline bool compare(const float a,
                    const T b) {  // NOLINT false-positive readability-avoid-const-params-in-decls,
	                               // google-runtime-int
	return std::fabs(a - b) < 0.001f;
}
template <typename T>
inline bool compare(const double a,
                    const T b) {  // NOLINT false-positive readability-avoid-const-params-in-decls
