...
void GameMapPacket::read(FileSystem& fs, Game& game, MapObjectLoader* const /*unused*/) {
...
void GameMapPacket::write(FileSystem& fs, Game& game, MapObjectSaver* const /*unused*/) {
