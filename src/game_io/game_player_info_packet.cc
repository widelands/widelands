...
void GamePlayerInfoPacket::read(FileSystem& fs, Game& game, MapObjectLoader* /*unused*/) {
	try {
		FileRead fr;
...
void GamePlayerInfoPacket::write(FileSystem& fs, Game& game, MapObjectSaver* /*unused*/) {
	FileWrite fw;
