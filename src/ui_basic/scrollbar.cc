...
Scrollbar::Scrollbar
	...
	m_knob_grabdelta(0),
	m_pic_minus
		(g_gr->imgcache().get(horiz ? "pics/scrollbar_left.png"  : "pics/scrollbar_up.png")),
	m_pic_plus
		(g_gr->imgcache().get(horiz ? "pics/scrollbar_right.png" : "pics/scrollbar_down.png")),
	m_pic_background
		(g_gr->imgcache().get("pics/scrollbar_background.png")),
	m_pic_buttons   (g_gr->imgcache().get("pics/but3.png"))
{
	set_think(true);
}
