...
struct ColorChooserImpl : public Panel {
	...
	ColorChooserImpl(Panel& parent, PanelStyle s, ColorChooser& c)
	   : Panel(&parent, s, "color_chooser_pane", 0, 0, kMainDimension + kSpacing + kSidebarWidth, kMainDimension),
	     chooser_(c) {
	}
