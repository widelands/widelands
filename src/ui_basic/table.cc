...
Table<void*>::Table(Panel* const parent,
   ...
   : Panel(parent, style, name, x, y, w, h),
     ...
     scrollbar_filler_button_(
        new Button(this, "scrollbar_filler", 0, 0, Scrollbar::kSize, headerheight_, button_style_, "")),
	...
	scrollbar_ = new Scrollbar(this, "scrollbar", get_w() - Scrollbar::kSize, headerheight_, Scrollbar::kSize,
