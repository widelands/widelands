...
StyleManager::StyleManager() {
	...
	add_styled_size(UI::StyledSize::kUIDefaultPanelDimensionNarrow, *element_table,
	                "ui_default_panel_dimension_narrow");
	add_styled_size(UI::StyledSize::kUIDefaultPanelDimensionMedium, *element_table,
	                "ui_default_panel_dimension_medium");
	add_styled_size(UI::StyledSize::kUIDefaultPanelDimensionLarge, *element_table,
	                "ui_default_panel_dimension_large");
