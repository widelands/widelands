...
int LuaPlayer::reveal_scenario(lua_State* L) {
    ...
    std::map<std::string, std::string> legacy_map{
        {"frisians02", "fri02.wmf"},
        {"frisians01", "fri01.wmf"},
        {"atlanteans01", "atl01.wmf"},
        {"empiretut04", "emp04.wmf"},
        {"empiretut03", "emp03.wmf"},
        {"empiretut02", "emp02.wmf"},
        {"empiretut01", "emp01.wmf"},
        {"barbariantut02", "bar02.wmf"},
