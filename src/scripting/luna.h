 ...
 */
template <class T, class PT> void add_parent(lua_State* L) {
 ...
 */
template <class T> int to_lua(lua_State* const L, T* const obj) {
 ...
 */
template <class T> T** get_base_user_class(lua_State* const L, int narg) {
	extract_userdata_from_user_class<T>(L, narg);
