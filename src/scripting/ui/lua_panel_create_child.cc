...
UI::Panel* LuaPanel::do_create_child_spinbox(lua_State* L, UI::Panel* parent) {
	...
	bool allow_multiline_label = get_table_boolean(L, "allow_multiline_label", false);
	...
	UI::SpinBox* spinbox =
	   new UI::SpinBox(parent, name, unit_w, val, val_min, val_max, panel_style(L), label, allow_multiline_label, units,
