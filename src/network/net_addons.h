...
struct NetAddons {
	...
	const std::vector<AddOnInfo>& refresh_remotes();
...
private:
	...
	// Do not download the list every time the addon menu is opened
	static uint32_t last_refresh_;
	static std::vector<AddOnInfo> remotes_;
};
