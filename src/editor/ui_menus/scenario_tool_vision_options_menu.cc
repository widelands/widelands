...
ScenarioToolVisionOptionsMenu::ScenarioToolVisionOptionsMenu(EditorInteractive& parent,
   ...
   : EditorToolOptionsMenu(parent, registry, 300, 30, _("Field Vision"), tool),
	...
	players_.selected.connect(boost::bind(&ScenarioToolVisionOptionsMenu::select_player, this));
	modes_.selected.connect(boost::bind(&ScenarioToolVisionOptionsMenu::select_mode, this));
