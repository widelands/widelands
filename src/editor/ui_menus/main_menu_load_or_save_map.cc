...
MainMenuLoadOrSaveMap::MainMenuLoadOrSaveMap(EditorInteractive& parent,
   ...
   : UI::UniqueWindow(
     ...
     main_box_(this, UI::PanelStyle::kWui, "main_box", padding_, padding_, UI::Box::Vertical, 0, 0, padding_),

     table_and_details_box_(
        &main_box_, UI::PanelStyle::kWui, "table_details_bpx", 0, 0, UI::Box::Horizontal, 0, 0, padding_),
     table_box_(
        &table_and_details_box_, UI::PanelStyle::kWui, "table_box", 0, 0, UI::Box::Vertical, 0, 0, padding_),

     table_(&table_box_, 0, 0, 200, 200, UI::PanelStyle::kWui),
     egbase_(nullptr),
     map_details_box_(
        &table_and_details_box_, UI::PanelStyle::kWui, "map_details_box", 0, 0, UI::Box::Vertical, 0, 0, padding_),
     ...
     table_footer_box_(&main_box_, UI::PanelStyle::kWui, "footer_box", 0, 0, UI::Box::Horizontal, 0, 0, padding_),

     directory_info_(&main_box_, UI::PanelStyle::kWui, "label_directory_info", UI::FontStyle::kWuiLabel, 0, 0, 0, 0),

     // Bottom button row
     button_box_(&main_box_, UI::PanelStyle::kWui, "buttons_box", 0, 0, UI::Box::Horizontal, 0, 0, padding_),
