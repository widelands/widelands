...
MainMenuNewRandomMap::MainMenuNewRandomMap(EditorInteractive& parent) :
	...
	players_(&box_, 0, 0, box_width_, box_width_ / 3,
			  2, 1, max_players_,
			  _("Players:"), UI::SpinBox::Units::kNone, g_gr->images().get("images/ui_basic/but1.png"), UI::SpinBox::Type::kSmall),
	// World + Resources
	world_descriptions_(
	{
	...
	water_(&box_, 0, 0, box_width_, box_width_ / 3,
			  waterval_, 0, 60,
			  _("Water:"), UI::SpinBox::Units::kPercent, g_gr->images().get("images/ui_basic/but1.png"), UI::SpinBox::Type::kSmall, 5),
	land_(&box_, 0, 0, box_width_, box_width_ / 3,
			  landval_, 0, 100,
			  _("Land:"), UI::SpinBox::Units::kPercent, g_gr->images().get("images/ui_basic/but1.png"), UI::SpinBox::Type::kSmall, 5),
