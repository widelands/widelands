...
UI::Checkbox* create_terrain_checkbox(UI::Panel* parent,
	...
	UI::Checkbox* cb =
	   new UI::Checkbox(parent, UI::PanelStyle::kWui, format("checkbox_%s", terrain_descr.name()), Vector2i::zero(), image.get(), tooltip);
   ...
   : EditorToolOptionsMenu(parent, registry, 0, 0, _("Terrain"), tool) {
	...
	multi_select_menu_.reset(
	   new CategorizedItemSelectionMenu<Widelands::TerrainDescription, EditorSetTerrainTool>(
	      this, "terrains", parent.editor_categories(Widelands::MapObjectType::TERRAIN), descriptions.terrains(),
