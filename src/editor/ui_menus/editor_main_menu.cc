...
:
	...
	button_exit_editor_
		(&box_, "exit",
		 ...
		 _("Exit Editor"))
{
	box_.add(&button_new_map_, UI::Align::Align_HCenter);
	box_.add(&button_new_random_map_, UI::Align::Align_HCenter);
	box_.add(&button_load_map_, UI::Align::Align_HCenter);
	box_.add(&button_save_map_, UI::Align::Align_HCenter);
	box_.add(&button_map_options_, UI::Align::Align_HCenter);
	box_.add(&button_view_readme_, UI::Align::Align_HCenter);
	box_.add(&button_exit_editor_, UI::Align::Align_HCenter);
