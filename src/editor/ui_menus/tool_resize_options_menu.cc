...
EditorToolResizeOptionsMenu::EditorToolResizeOptionsMenu(EditorInteractive& parent,
   ...
   : EditorToolOptionsMenu(parent, registry, 260, 200, _("Resize"), resize_tool),
     ...
     text_area_(
        ...
        48,
        UI::PanelStyle::kWui,
        _("Select the new map size, then click the map to split it at the desired location. When increasing the map size, new columns/rows will be inserted to the east/south of the selected point. When shrinking the map, the desired number of columns/rows will be removed from the east/south of the splitting location."),
        UI::Align::kCenter,
