...
MainMenuNewMap::MainMenuNewMap(EditorInteractive & parent)
	...
	width_(&box_, 0, 0, box_width_, box_width_ / 3,
			 0, 0, 0,
			 _("Width:"), UI::SpinBox::Units::kNone, g_gr->images().get("images/ui_basic/but1.png"), UI::SpinBox::Type::kValueList),
	height_(&box_, 0, 0, box_width_, box_width_ / 3,
			  0, 0, 0,
			  _("Height:"), UI::SpinBox::Units::kNone, g_gr->images().get("images/ui_basic/but1.png"), UI::SpinBox::Type::kValueList),
