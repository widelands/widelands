...
MainMenuNewRandomMap::MainMenuNewRandomMap(UI::Panel& parent,
   ...
   : UI::UniqueWindow(&parent, s, "random_map_menu", &registry, 400, 500, _("New Random Map")),
     ...
     world_(&box_,
            ...
            panel_style_,
            panel_style_ == UI::PanelStyle::kWui ? UI::ButtonStyle::kWuiSecondary : UI::ButtonStyle::kFsMenuSecondary),
     resources_(&box_,
                "resources",
                0,
                0,
     ...
     mountains_(&mountains_box_, panel_style_, label_style_,
                0,
                0,
                box_width_ / 3,
     ...
     map_number_and_id_vbox_1_(&map_number_and_id_hbox_, panel_style_, 0, 0, UI::Box::Vertical, 0, 0, margin_),
     map_number_and_id_vbox_2_(&map_number_and_id_hbox_, panel_style_, 0, 0, UI::Box::Vertical, 0, 0, margin_),
     map_number_label_(&map_number_and_id_vbox_1_, panel_style_, label_style_, 0, 0, 0, 0, _("Random number:")),
     map_number_edit_(&map_number_and_id_vbox_2_,
                      0,
                      0,
                      box_width_ - 2 * margin_ - map_number_label_.get_w(),
                      panel_style_),
     map_id_label_(&map_number_and_id_vbox_1_, panel_style_, label_style_, 0, 0, 0, 0, _("Map ID:")),
     ...
     ok_button_(&button_box_,
                ...
                0,
                panel_style_ == UI::PanelStyle::kWui ? UI::ButtonStyle::kWuiPrimary : UI::ButtonStyle::kFsMenuPrimary,
                _("Generate Map")),
