...
MainMenuNewRandomMap::MainMenuNewRandomMap(UI::Panel& parent,
   ...
   : UI::UniqueWindow(&parent, s, "random_map_menu", &registry, 400, 500, _("New Random Map")),
     style_(s),
     label_style_(s == UI::WindowStyle::kWui ? UI::FontStyle::kWuiLabel : UI::FontStyle::kFsMenuLabel),
     // UI elements
     margin_(4),
     ...
     wasteland_(&box_,
                ...
                UI::SpinBox::Type::kSmall,
                5),
     mountains_box_(&box_, UI::PanelStyle::kWui, 0, 0, UI::Box::Horizontal, 0, 0, margin_),
     mountains_label_(&mountains_box_, UI::PanelStyle::kWui, label_style_, 0, 0, 0, 0, _("Mountains:")),
     mountains_(&mountains_box_, UI::PanelStyle::kWui, label_style_,
                0,
                0,
                box_width_ / 3,
     ...
     // Geeky stuff
     map_number_and_id_hbox_(&box_, UI::PanelStyle::kWui, 0, 0, UI::Box::Horizontal, 0, 0, margin_),
     map_number_and_id_vbox_1_(&map_number_and_id_hbox_, UI::PanelStyle::kWui, 0, 0, UI::Box::Vertical, 0, 0, margin_),
     map_number_and_id_vbox_2_(&map_number_and_id_hbox_, UI::PanelStyle::kWui, 0, 0, UI::Box::Vertical, 0, 0, margin_),
     map_number_label_(&map_number_and_id_vbox_1_, UI::PanelStyle::kWui, label_style_, 0, 0, 0, 0, _("Random number:")),
     map_number_edit_(&map_number_and_id_vbox_2_,
                      0,
                      0,
                      box_width_ - 2 * margin_ - map_number_label_.get_w(),
                      UI::PanelStyle::kWui),
     map_id_label_(&map_number_and_id_vbox_1_, UI::PanelStyle::kWui, label_style_, 0, 0, 0, 0, _("Map ID:")),
