...
MainMenuNewRandomMapPanel::MainMenuNewRandomMapPanel(UI::Panel& parent,
   ...
   : UI::Box(&parent, s, kMargin, kMargin, UI::Box::Vertical, 0, 0, kMargin),
     ...
     mountains_label_(&mountains_box_, panel_style_, "mountains_label", label_style_, 0, 0, 0, 0, _("Mountains:")),
     mountains_(&mountains_box_,
                panel_style_, "mountains",
                label_style_,
                0,
                0,
                inner_w / 3,
     ...
     // Geeky stuff
     map_number_and_id_hbox_(this, panel_style_, "id_hbox", 0, 0, UI::Box::Horizontal, 0, 0, kMargin),
     ...
     random_number_hbox_(
        &map_number_and_id_vbox_2_, panel_style_, "seed_hbox", 0, 0, UI::Box::Horizontal, 0, 0, kMargin),
     map_number_label_(
        &map_number_and_id_vbox_1_, panel_style_, "seed_label", label_style_, 0, 0, 0, 0, _("Random number:")),
     map_number_edit_(&random_number_hbox_, "seed_editbox",
                      0,
                      0,
     ...
     map_id_label_(
        &map_number_and_id_vbox_1_, panel_style_, "id_label", label_style_, 0, 0, 0, 0, _("Map ID:")),
     map_id_edit_(&map_number_and_id_vbox_2_, "id_editbox",
                  0,
                  0,
