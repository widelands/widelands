...
MainMenuNewRandomMap::MainMenuNewRandomMap(UI::Panel& parent,
   ...
   : UI::UniqueWindow(&parent, s, "random_map_menu", &registry, 400, 500, _("New Random Map")),
     ...
     mountains_label_(&mountains_box_, label_style_, 0, 0, 0, 0, _("Mountains:")),
     mountains_(&mountains_box_, label_style_,
                0,
                0,
                box_width_ / 3,
     ...
     map_number_label_(&map_number_and_id_vbox_1_, label_style_, 0, 0, 0, 0, _("Random number:")),
     map_number_edit_(&map_number_and_id_vbox_2_,
                      0,
                      0,
                      box_width_ - 2 * margin_ - map_number_label_.get_w(),
                      UI::PanelStyle::kWui),
     map_id_label_(&map_number_and_id_vbox_1_, label_style_, 0, 0, 0, 0, _("Map ID:")),
