...
uint32_t EditorHistory::undo_action() {
	...
	return uac.tool.handle_undo(static_cast<EditorTool::ToolIndex>(uac.i), uac.center,
...
uint32_t EditorHistory::redo_action() {
	...
	return rac.tool.handle_click(static_cast<EditorTool::ToolIndex>(rac.i), rac.center,
