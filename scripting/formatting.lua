...
function h1(s)
   return "<p font-face=FreeSerif font-size=18 font-weight=bold font-color=D1D1D1>"
...
--    :returns: A paragraph with s formatted as heading.
function h2(s)
   return "<p font-face=FreeSerif font-size=14 font-weight=bold font-color=D1D1D1>"
...
--
function h3(s)
   return "<p font-face=FreeSerif font-size=13 font-style=italic font-color=D1D1D1>"
      ..  s .. "<br></p><p font-size=4> <br></p>"
end
...
--
function h4(s)
   return "<p font-face=FreeSerif font-size=12 font-style=italic font-color=D1D1D1>"
      ..  s .. "<br></p><p font-size=4> <br></p>"
end
