...
**enhancement**
    *Optional*. A table defining the name of a building that this building can be enhanced to,
    ...
    table contents can be empty.
    Since v1.3, the optional ``base_animation`` key allows specifying a base animation for the
    build animation of the enhanced building that will be used instead of this building's
    unoccupied animation.
    Example::
        ...
        enhancement = {
           ...
           base_animation = "enhancement_base",
        },
