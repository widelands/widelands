...
**enhancement**
    *Optional*. A table defining name of a building that this building can be enhanced to,
    and its additional build cost and wares that this building will give back to the player
