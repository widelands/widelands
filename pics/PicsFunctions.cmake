...
foreach (jpg_tmp ${JPG_LIST})
  ...
  execute_process (RESULT_VARIABLE copyret COMMAND ${CMAKE_COMMAND} -E copy ${jpg_tmp} ${WL_CURRENT_BINARY_DIR}/${jpg_tmp_filename})
endforeach (jpg_tmp ${JPG_LIST})

foreach (png_tmp ${PNG_LIST})
  get_filename_component(png_tmp_filename ${png_tmp} NAME)
  execute_process (RESULT_VARIABLE copyret COMMAND ${CMAKE_COMMAND} -E copy ${png_tmp} ${WL_CURRENT_BINARY_DIR}/${png_tmp_filename})
