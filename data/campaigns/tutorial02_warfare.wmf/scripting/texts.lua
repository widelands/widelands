...
hq_status = {
   ...
   body = (
      ...
      p(_([[While all soldiers who happen to be in your headquarters help defending it, they are not permanently assigned to the headquarters, so they can be sent away any time when a military site needs a soldier. Fortunately you can also assign some soldiers to the defense of the headquarters the same way you set soldier capacity and preference for military sites. If you do so, the headquarters will only let surplus soldiers be sent to other buildings, not the assigned defenders.]])) ..
      p(_([[If you look at the status lines, you can see that your warehouse has nothing in it, but your headquarters has a ‘—’ sign initially. That means that there are no soldiers assigned to protect the headquarters, though there may still be some soldiers stored there. If you assign some soldiers, the headquarters will show the same soldier information as military sites in the status. Surplus soldiers are never shown in the status.]]))
   )
}
