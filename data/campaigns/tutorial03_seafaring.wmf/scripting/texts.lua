...
tell_about_port_building = {
   ...
   rt("image=data/pics/port.png", p(_[[blue port space icon.]])) ..
   rt(
...
tell_about_ships = {
   ...
   rt("image=data/pics/stop.png",p(_[[This is the icon for stopping production. You will find it in the building window.]])),
...
expedition2 = {
   ...
   rt("image=data/pics/start_expedition.png",p(_[[To do so, click on the ‘Start Expedition’ button in any port. A new tab where you can see the needed wares will appear.]])
   )
}
