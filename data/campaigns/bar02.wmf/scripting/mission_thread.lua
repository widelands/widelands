...
function foottracks()
   ...
   local prior_view = scroll_to_field(game.map:get_field(67,19))
...
function mining_and_trainingsites()
   ...
   local prior_view = scroll_to_field(game.map:get_field(82,20))
...
function renegade_fortresses()
   ...
   local prior_view = scroll_to_field(map:get_field(120,92))
