...
building_stat = {
   ...
   rt("image=data/pics/menu_toggle_menu.png",p(_[[First, you will have to open the statistics menu (you can find the corresponding button at the bottom). We will need this menu several times.]])) ..
   rt("image=data/pics/menu_building_stats.png",p(_[[Afterwards, choose the ‘Building statistics’.]]) ..
      paragraphdivider() ..
   ...
   obj_body =
      rt("image=data/pics/menu_building_stats.png", p(_[[The building statistics window gives you an overview over the buildings you have.]])) ..
   rt(
      paragraphdivider() ..
...
inventory1 = {
   ...
   rt("image=data/pics/menu_stock.png",p(_[[Click on the ‘Stock’ button.]])) ..
   rt(
      paragraphdivider() ..
...
inventory2 = {
   ...
   rt("image=data/pics/menu_tab_wares_warehouse.png",p(_[[third tab (‘Wares in warehouses’), I’ll continue.]])
   ),
   h = 350,
   show_instantly = true,
...
ware_encyclopedia = {
   ...
   rt("image=data/pics/menu_help.png",p(_[[the help button at the bottom. For all your tribe’s wares, it shows a short help text, a list of buildings that produces the ware and the needed wares.]]) ..
...
ware_stats1 = {
   ...
   body = rt(
      ...
      rt("image=data/pics/menu_ware_stats.png",p(_[[‘Ware statistics’ button.]])) ..
      rt(paragraphdivider() ..
...
ware_stats2 = {
   ...
   rt("image=data/pics/menu_tab_wares_econ_health.png",p(_[[third tab (‘Economy Health’).]])
   ),
   h = 250,
   show_instantly = true,
...
economy_settings1 = {
   ...
   rt("image=data/pics/genstats_nrwares.png",p(_[[This is the icon.]])) ..
   rt(
      paragraphdivider() ..
