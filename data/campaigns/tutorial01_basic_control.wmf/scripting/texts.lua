...
lumberjack_message_05 = {
   ...
   rt("image=data/pics/menu_build_flag.png", p(_"build flag symbol.")
   ),
   h = 300,
...
tell_about_minimap = {
   ...
   rt("image=data/pics/menu_toggle_minimap.png", p(_[[minimap button at the bottom of the screen or simply by using the keyboard shortcut ‘m’.]])
   ) ..
   rt(
...
order_quarry_recap_how_to_build = {
   ...
   rt("image=data/pics/big.png", p(_[[Everything can be built on the green house symbol.]])) ..
   rt("image=data/pics/medium.png", p(_[[Everything except for big buildings can be built on a yellow house symbol.]])) ..
   rt("image=data/pics/small.png", p(_[[Red building symbols can only hold small buildings and flags.]])) ..
   rt("image=data/pics/set_flag.png", p(_[[And finally, the yellow flag symbol only allows for flags.]])) ..
   rt(
...
talk_about_roadbuilding_00a = {
   ...
   rt("image=data/pics/menu_build_way.png", p(_[[the road building symbol.]])) ..
   rt(
   ...
   rt("image=data/pics/menu_abort.png", p(_[[the abort symbol.]])) ..
   rt(
...
talk_about_roadbuilding_02 = {
   ...
   rt("image=data/pics/roadb_green.png", p(_[[The terrain is flat here. Your carriers will be very swift on this terrain.]])) ..
   rt("image=data/pics/roadb_yellow.png", p(_[[There is a small slope to climb to reach this field. This means that your workers will be faster walking downhill than they will be walking uphill.]])) ..
   rt("image=data/pics/roadb_red.png", p(_[[The connection between the fields is extremely steep. The speed increase in one direction is huge while the slowdown in the other is also substantial.]])) ..
   rt(
...
teaching_about_messages = {
   ...
   rt("image=data/pics/message_archive.png", p(_[[archive message button to move them into your archive.]])) ..
   rt(
      paragraphdivider() ..
...
conclude_tutorial = {
   ...
   rt("image=data/pics/menu_options_menu.png", p(_[[‘Options’ menu button on the very left at the bottom of the screen. Then click the]])) ..
   rt("image=data/pics/menu_exit_game.png", p(_[[‘Exit Game’ button.]])) ..
