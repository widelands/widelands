...
function mission_thread()
   ...
   prefilled_buildings(p5,
      ...
      { "barbarians_scouts_hut",    80, 30, wares = {ration = 2} }
   )
   ...
   if immovable_has_name(port_island.immovable, "barbarians_port") then
      add_wares(port_island, "gold", 14)
      add_wares(port_island, "ax", 16)
      add_wares(port_island, "ax_sharp", 12)
      add_wares(port_island, "ax_broad", 9)
      add_wares(port_island, "ax_bronze", 7)
      add_wares(port_island, "ax_battle", 6)
      add_wares(port_island, "ax_warriors", 4)
      add_wares(port_island, "helmet", 15)
      add_wares(port_island, "helmet_mask", 14)
      add_wares(port_island, "helmet_warhelm", 12)
      add_wares(port_island, "beer", 24)
      add_wares(port_island, "beer_strong", 13)
   end
