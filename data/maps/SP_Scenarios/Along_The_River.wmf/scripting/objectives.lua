...
obj_build_warehouse = {
   ...
   body = objective_text(_"Build a Warehouse near the Pirate Sentry.",
      li_image("tribes/buildings/warehouses/barbarians/warehouse/menu.png", _[[Build a warehouse close to the conquered pirate sentry near the brook. We will need it as a basis for further exploitation. Furthermore we could use it to store some gold that we will mine from the surrounding hills.]])
   ),
}
