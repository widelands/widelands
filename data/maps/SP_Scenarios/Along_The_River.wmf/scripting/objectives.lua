...
obj_build_port = {
   ...
   number = 1,
   body = objective_text(_"Build a port in the land of Törver.",
      li_image("tribes/buildings/warehouses/barbarians/port/menu.png", _[[We should be ready to send an expedition as soon as we found out how to build ships.]])
   ),
}
...
obj_conquer_pirate_sentry = {
   ...
   number = 1,
   body = objective_text(_"Conquer the pirate sentry near the brook to the east.",
      li_image("tribes/buildings/militarysites/barbarians/sentry/menu.png", _[[Hopefully we will find out what happened to the gold in this area.]])
   ),
}
...
obj_bring_shovels_1 = {
   ...
   number = 1,
   body = objective_text(_"Bring four shovels to the warehouse near the brook.",
