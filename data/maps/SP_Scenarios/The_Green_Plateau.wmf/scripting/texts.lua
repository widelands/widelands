...
briefing_2_found_ancient_castle = {
   ...
   body = objective_text(_("An Ancient Castle"),
      p(_([[By the Gods! One of our scouts has discovered a mighty castle at the center of the old plateau. The castle must be quite old and seems to have been built in a foreign style. It’s quite obvious that this is not Barbarians craft.]])) ..
