...
-- The file **has to be located in** ``tribes/tribes/<tribename>/init.lua`` so that the engine can find it.
--
...
-- ---------------------------------
--
-- The ``tribes/tribes/<tribename>/units.lua`` file configures the units that a tribe can use.
--
