function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Meat
      amazons = pgettext("amazons_ware", "Meat is used by the food preserver to prepare rations for the miners. It is also consumed at the training sites (training glade and warriors gathering)."),
      -- TRANSLATORS: Helptext for a ware: Meat
      ...
      -- TRANSLATORS: Helptext for a ware: Meat
      frisians = pgettext("frisians_ware", "Meat has to be smoked in a smokery before being delivered to taverns, drinking halls and training sites."),
      -- TRANSLATORS: Helptext for a ware: Meat
