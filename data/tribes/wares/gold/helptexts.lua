function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Gold
      frisians = pgettext("frisians_ware", "Only very important things are embellished with gold. It is used to produce better swords and the best helmets. The best armor is also decorated with gold."),
      -- TRANSLATORS: Helptext for a ware: Gold
