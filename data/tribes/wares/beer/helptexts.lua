function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Beer
      frisians = pgettext("frisians_ware", "Beer is produced in breweries and used in drinking halls to produce meals. Soldiers drink beer while receiving basic training."),
      -- TRANSLATORS: Helptext for a ware: Beer
