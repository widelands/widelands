function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Smoked Meat
      frisians = pgettext("frisians_ware", "Meat is smoked in a tannery. Smoked meat is then consumed by soldiers in training or turned into rations and meals for miners.")
   }
   local result = ""
   if tribe then
