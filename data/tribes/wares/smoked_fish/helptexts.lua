function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Smoked Fish
      frisians = pgettext("frisians_ware", "Fish is smoked in a tannery. Smoked fish is then consumed by soldiers in training or turned into rations and meals for miners.")
   }
   local result = ""
   if tribe then
