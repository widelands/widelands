function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Helmet
      frisians = pgettext("frisians_ware", "A helmet is a basic tool to protect warriors. It is produced in the armor smithy and used to train warriors from health level 0 to level 1.")
   }
   local result = ""
   if tribe then
