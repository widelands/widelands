function ware_helptext(tribe)
   local helptext = {
      ...
      -- TRANSLATORS: Helptext for a ware: Log
      frisians = pgettext("frisians_ware", "Woodcutters fell the trees; foresters take care of the supply of trees. Logs are also used in the blacksmithy to build basic tools, and in the charcoal kiln for the production of coal. Smokeries use logs as fuel for smoking meat and fish."),
      -- TRANSLATORS: Helptext for a ware: Log
