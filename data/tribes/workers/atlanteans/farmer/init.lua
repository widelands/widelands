...
wl.Descriptions():new_worker_type {
   ...
   programs = {
      plant = {
         ...
         -- std worker time: 2 * 3.385 * 1.8 + 6 + 6 = 24.186 sec
         -- ideal worker time: 2 * 2.2 * 1.8 + 6 + 6 = 19.92 sec
      ...
      harvest = {
         -- std worker time: 2 * 3.385 * 1.8 + 10 + 4 = 26.186 sec
         -- ideal worker time: 2 * 2.2 * 1.8 + 10 + 4 = 21.92 sec
