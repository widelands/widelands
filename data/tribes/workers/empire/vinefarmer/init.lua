...
wl.Descriptions():new_worker_type {
   ...
   programs = {
      plant = {
         ...
         -- min. worker time (4 fields): 2 * 2.5 * 1.8 + 5 + 5 = 19    sec
         -- worker time:                 2 * 2.8 * 1.8 + 5 + 5 = 20.08 sec
      ...
      harvest = {
         -- min. worker time (4 fields): 2 * 2.5 * 1.8 + 8 + 2 = 19    sec
         -- worker time:                 2 * 2.8 * 1.8 + 8 + 2 = 20.08 sec
