...
function building_helptext_lore()
   ...
   return pgettext("barbarians_building", [[‘Behind the next hill there might be wealth and happiness but also hostility and doom.<br>
         He who doesn’t explore it commits the crime of stupidity.’]])
end

function building_helptext_lore_author()
   -- TRANSLATORS: Lore author helptext for a building
   return pgettext("barbarians_building", "Chat’Karuth<br> at the oath taking ceremony of the first scout troup ")
end
