      ...
      -- Small
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("empire_building", "This building can produce one granite or one marble between %1$s and %2$s, depending on how far the stonemason has stones."):bformat(format_seconds(42), format_minutes_seconds(1, 7)),
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("empire_building", "This building can produce one log between %1$s and %2$s, depending on how far the lumberjack has trees."):bformat(format_seconds(49), format_minutes_seconds(1, 29)),
               -- TRANSLATORS: Performance helptext for an Empire production site: Lumberjack's House
               pgettext("empire_building", "In case of slopes or obstacles in the way, the time is increased.")
            }
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("empire_building", "The forester plants one tree between %1$s and %2$s."):bformat(format_seconds(23), format_seconds(45)),
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("empire_building", "This building can produce one fish between %1$s and %2$s, depending on how far the fisher has water."):bformat(format_seconds(27), format_seconds(56)),
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("empire_building", "This building can produce one meat between %1$s and %2$s, depending on how far the hunter has animals."):bformat(format_seconds(43), format_minutes_seconds(1, 34)),
