...
--[[ lore template
      ...
      -- Military Sites
      {
         ...
         helptexts = {
            ...
            lore_author = pgettext("General ??? on why he didn't order the destruction of a rebel Blockhouse"),
      ...
      },
      {
         ...
         helptexts = {
            ...
            lore_author = pgettext("Rebel general ??? upon entering the limits of Fremil to overthrow the government"),
