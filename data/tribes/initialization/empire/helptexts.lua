...
return {
   ...
   wares = {
      armor = {
         ...
         pgettext(warectxt, "Basic armor for Empire soldiers. It is produced in the armor smithy and used in the training camp – together with food – to train soldiers from health level 1 to level 2.")
      },
      armor_chain = {
         -- TRANSLATORS: Helptext for a ware: Chain Armor
         pgettext(warectxt, "The chain armor is a medium armor for Empire soldiers. It is produced in an armor smithy and used in a training camp – together with food – to train soldiers from health level 2 to level 3.")
      },
      armor_gilded = {
         -- TRANSLATORS: Helptext for a ware: Gilded Armor
         pgettext(warectxt, "The gilded armor is the strongest armor an Empire soldier can have. It is produced in the armor smithy and used in the training camp – together with food – to train soldiers from health level 3 to level 4.")
      },
      armor_helmet = {
         -- TRANSLATORS: Helptext for a ware: Helmet
         pgettext(warectxt, "The helmet is the basic defense of a warrior. It is produced in an armor smithy. In combination with a wooden spear, it is the equipment to fit out young soldiers. Helmets are also used in training camps – together with food – to train soldiers from health level 0 to level 1.")
      },
      basket = {
         -- TRANSLATORS: Helptext for a ware: Basket
         pgettext(warectxt, "This basket is needed by the vine farmer for harvesting the grapes. It is produced by the toolsmith.")
      },
      beer = {
         -- TRANSLATORS: Helptext for a ware: Beer
         pgettext(warectxt, "This beer is produced in a brewery out of wheat and water. It is consumed by miners in coal and iron mines.")
      },
      bread_paddle = {
      ...
      cloth = {
         ...
         pgettext(warectxt, "Cloth is needed to build several buildings. It is also consumed in the armor smithy.")
      },
      coal = {
      ...
      empire_bread = {
         ...
         pgettext(warectxt, "The bakers of the Empire make really tasty bread out of flour and water. It is used in taverns and inns to prepare rations and meals. Bread is also consumed at the training sites (arena, colosseum, training camp).")
      },
      felling_ax = {
      ...
      fish = {
         ...
         pgettext(warectxt, "Besides bread and meat, fish is also a foodstuff for the Empire. Fish are used in taverns, inns and training sites (arena, colosseum, training camp).")
      },
      fishing_rod = {
      ...
      flour = {
         ...
         pgettext(warectxt, "Flour is produced by the mill out of wheat and is needed in the bakery to produce the tasty Empire bread.")
      },
      gold = {
      ...
      grape = {
         ...
         pgettext(warectxt, "These grapes are the base for a tasty wine. They are harvested in a vineyard and processed in a winery.")
      },
      hammer = {
      ...
      kitchen_tools = {
         ...
         pgettext(warectxt, "Kitchen tools are needed for preparing rations and meals. They are produced in a toolsmithy and used in taverns and inns.")
      },
      log = {
      ...
      marble = {
         ...
         pgettext(warectxt, "Marble is the beautiful stone which is cut out of the mountains or produced in a quarry. Marble is used as a building material and gets chiseled into marble columns in the stonemason’s house.")
      },
      marble_column = {
         -- TRANSLATORS: Helptext for a ware: Marble Column
         pgettext(warectxt, "Marble columns represent the high culture of the Empire, so they are needed for nearly every larger building. They are produced out of marble at a stonemason’s house.")
      },
      meal = {
         -- TRANSLATORS: Helptext for a ware: Meal
         pgettext(warectxt, "A real meal is made in inns out of bread and fish/meat. It satisfies the needs of miners in deep mines.")
      },
      meat = {
      ...
      pick = {
         ...
         pgettext(warectxt, "Picks are used by stonemasons and miners. They are produced by the toolsmith.")
      },
      planks = {
      ...
      saw = {
         ...
         pgettext(warectxt, "This saw is needed by the carpenter. It is produced by the toolsmith.")
      },
      scythe = {
      ...
      spear = {
         ...
         pgettext(warectxt, "This spear has an iron spike. It is produced in a weapon smithy and used in a training camp – together with food – to train soldiers from attack level 0 to attack level 1.")
      },
      spear_advanced = {
         -- TRANSLATORS: Helptext for a ware: Advanced Spear
         pgettext(warectxt, "This is an advanced spear with a steel tip. It is produced in a weapon smithy and used in a training camp – together with food – to train soldiers from attack level 1 to level 2.")
      },
      spear_heavy = {
         -- TRANSLATORS: Helptext for a ware: Heavy Spear
         pgettext(warectxt, "This is a strong spear with a steel-tip and a little blade. It is produced in the weapon smithy and used in the training camp – together with food – train soldiers from attack level 2 to level 3.")
      },
      spear_war = {
         -- TRANSLATORS: Helptext for a ware: War Spear
         pgettext(warectxt, "This is the best and sharpest weapon the Empire weaponsmith creates for the soldiers. It is used in the training camp – together with food – to train soldiers from attack level 3 to level 4.")
      },
      spear_wooden = {
         -- TRANSLATORS: Helptext for a ware: Wooden Spear
         pgettext(warectxt, "This wooden spear is the basic weapon in the Empire military system. It is produced in the weapon smithy. In combination with a helmet, it is the equipment to fit out young soldiers.")
      },
      water = {
      ...
      wine = {
         ...
         pgettext(warectxt, "This tasty wine is drunk by the miners working the marble and gold mines. It is produced in a winery.")
      },
      wool = {
         -- TRANSLATORS: Helptext for a ware: Wool
         pgettext(warectxt, "Wool is the hair of sheep. Weaving mills use it to make cloth.")
      }
    }
}
