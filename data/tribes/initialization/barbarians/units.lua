      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("barbarians_building", "This building can produce one ship between %1$s and %2$s, depending on how far the shipwright has to walk."):bformat(format_minutes_seconds(18, 8), format_minutes_seconds(24, 51)),
