   ...
   buildings = {
      ...
      -- Small
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The stonemason pauses %1% before going back to work again."):bformat(format_seconds(65))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("barbarians_building", "The lumberjack needs %1% to fell a tree, not counting the time he needs to reach the destination and go home again."):bformat(format_seconds(17)),
               -- TRANSLATORS: Performance helptext for a barbarian production site: Lumberjack_s Hut
               pgettext("barbarians_building", "Afterwards he rests in the hut for %1%."):bformat(format_seconds(20))
            }
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The ranger needs %1% to plant a tree, not counting the time he needs to reach the destination and go home again."):bformat(format_seconds(5))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The fisher pauses %1% before going to work again."):bformat(format_seconds(18))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The hunter pauses %1% before going to work again."):bformat(format_seconds(35))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The gamekeeper pauses %1% before going to work again."):bformat(format_seconds(53))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The carrier needs %1% to get one bucket full of water."):bformat(format_seconds(40))
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "A reed yard can produce a sheaf of reed in about %1% on average."):bformat(format_seconds(65))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce grout in about %1% on average."):bformat(format_seconds(41))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce a pitta bread in %1% on average."):bformat(format_seconds(34))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce beer in about %1% on average."):bformat(format_seconds(64))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce strong beer in about %1% on average."):bformat(format_seconds(64))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The tavern can produce one ration in %1% on average, if the supply is steady."):bformat(format_seconds(37))
         }
      },
      {
         name = "barbarians_inn",
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The inn can produce one ration in %1% and one snack in %2% on average, if the supply is steady."):bformat(format_seconds(37), format_seconds(41))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The big inn can produce one ration in %1%, one snack in %2% and one meal in %3% on average, if the supply is steady."):bformat(format_seconds(37), format_seconds(41), format_seconds(44))
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce each tool in about %1% on average."):bformat(format_seconds(71))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce each type of ax in about %1% on average."):bformat(format_seconds(61)),
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "The barracks need %1% on average to recruit one soldier."):bformat(format_seconds(30))
         }
      },
      ...
      -- Big
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce an ox in %1% on average."):bformat(format_seconds(30))
         }
      },
      {
      ...
      -- Mines
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce granite in %1% on average."):bformat(format_seconds(24))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce coal in %1% on average."):bformat(format_seconds(36))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce coal in %1% on average."):bformat(format_seconds(23))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce coal in %1% on average."):bformat(format_seconds(18))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce iron ore in %1% on average."):bformat(format_seconds(69))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce iron ore in %1% on average."):bformat(format_seconds(23))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce iron ore in %1% on average."):bformat(format_seconds(21))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce gold ore in %1% on average."):bformat(format_seconds(69))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce gold ore in %1% on average."):bformat(format_seconds(23))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If the food supply is steady, this mine can produce gold ore in %1% on average."):bformat(format_seconds(22))
         }
      },
      ...
      -- Training Sites
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, a battle arena can train evade for one soldier from 0 to the highest level in %1% on average."):bformat(format_minutes_seconds(1, 10))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("barbarians_building", "If all needed wares are delivered in time, a training camp can train one new soldier in attack and health to the final level in %1% on average."):bformat(format_minutes_seconds(4, 40))
         }
      },
