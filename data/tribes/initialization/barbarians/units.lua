...
wl.Descriptions():new_tribe {
   ...
   wares_order = {
      {
         -- Building Materials
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Granite, part 1
                  pgettext("ware", "Granite is a basic building material."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Granite, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Log, part 1
                  pgettext("ware", "Logs are an important basic building material. They are produced by felling trees."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Log, part 2
                  pgettext("barbarians_ware", "Barbarians lumberjacks fell the trees; rangers take care of the supply of trees. Logs are also used in the metal workshop to build basic tools, and in the charcoal kiln for the production of coal. The wood hardener refines logs into blackwood by hardening them with fire.")
               }
            }
         },
         {
            ...
            preciousness = 10,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Blackwood
         ...
         },
         {
            ...
            preciousness = 5,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Grout
         ...
         },
         {
            ...
            preciousness = 5,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Reed
         ...
         },
         {
            ...
            preciousness = 0,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Cloth
               purpose = pgettext("barbarians_ware", "Cloth is needed for Barbarians ships. It is produced out of reed.")
            }
         }
      },
      {
         -- Food
         {
            ...
            preciousness = 3,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Fish
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Meat, part 1
                  pgettext("ware", "Meat contains a lot of energy, and it is obtained from wild game taken by hunters."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Meat, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Water, part 1
                  pgettext("ware", "Water is the essence of life!"),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Water, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Wheat, part 1
                  pgettext("ware", "Wheat is essential for survival."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Wheat, part 2
         ...
         },
         {
            ...
            preciousness =  2,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Beer
         ...
         },
         {
            ...
            preciousness = 2,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Strong Beer
         ...
         },
         {
            ...
            preciousness = 5,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Snack
         ...
         },
         {
            ...
            preciousness = 5,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Meal
      ...
      },
      {
         -- Mining
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Coal, part 1
                  pgettext("ware", "Coal is mined in coal mines or produced out of logs by a charcoal kiln."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Coal, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Iron Ore, part 1
                  pgettext("default_ware", "Iron ore is mined in iron mines."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Iron Ore, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Iron, part 1
                  pgettext("ware", "Iron is smelted out of iron ores."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Iron, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Gold Ore, part 1
                  pgettext("ware", "Gold ore is mined in a gold mine."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Gold Ore, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Gold, part 1
                  pgettext("ware", "Gold is the most valuable of all metals, and it is smelted out of gold ore."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Gold, part 2
      ...
      },
      {
         -- Tools
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Pick
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Felling Ax, part 1
                  pgettext("ware", "The felling ax is the tool to chop down trees."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Felling Ax, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Shovel, part 1
                  pgettext("ware", "Shovels are needed for the proper handling of plants."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Shovel, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Hammer, part 1
                  pgettext("ware", "The hammer is an essential tool."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Hammer, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Fishing Rod, part 1
                  pgettext("ware", "Fishing rods are needed by fishers to catch fish."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Fishing Rod, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Hunting Spear, part 1
                  ...
                  -- TRANSLATORS: Helptext for a Barbarians ware: Hunting Spear, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Scythe, part 1
                  pgettext("ware", "The scythe is the tool of the farmers."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Scythe, part 2
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Bread Paddle, part 1
                  pgettext("ware", "The bread paddle is the tool of the baker, each baker needs one."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Bread Paddle, part 2
         ...
         },
         {
            ...
            preciousness = 0,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Kitchen Tools
         ...
         },
         {
            ...
            helptexts = {
               purpose = {
                  -- TRANSLATORS: Helptext for a Barbarians ware: Fire Tongs, part 1
                  pgettext("ware", "Fire tongs are the tools for smelting ores."),
                  -- TRANSLATORS: Helptext for a Barbarians ware: Fire Tongs, part 2
      ...
      },
      {
         -- Weapons & Armor
         {
            ...
            preciousness = 3,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Ax
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Sharp Ax
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Broad Ax
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Bronze Ax
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Battle Ax
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Warrior’s Ax
               purpose = pgettext("barbarians_ware", "The warrior’s ax is the most dangerous of all Barbarians weapons. Only a few soldiers ever were able to handle this huge and powerful ax. It is produced in a war mill and used – together with food – in a training camp to train soldiers from attack level 4 to level 5.")
            }
         },
         {
            name = "helmet",
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Helmet
         ...
         },
         {
            ...
            preciousness = 1,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Mask
               purpose = pgettext("barbarians_ware", "A mask is an enhanced armor for Barbarians soldiers. It is produced in the helm smithy and used in the training camp – together with food – to train soldiers from health level 1 to level 2.")
            }
         },
         {
            name = "helmet_warhelm",
            ...
            preciousness = 2,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians ware: Warhelm
               purpose = pgettext("barbarians_ware", "This is the most enhanced Barbarians armor. It is produced in a helm smithy and used in a training camp – together with food – to train soldiers from health level 2 to level 3.")
            }
         }
      }
   },
   ...
   workers_order = {
      {
         -- Carriers
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Carrier
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Ferry
         ...
         },
         {
            ...
            preciousness = 2,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Ox
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Cattle Breeder
      ...
      },
      {
         -- Building Materials
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Stonemason
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Lumberjack
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Ranger
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Builder
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Lime-Burner
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Gardener
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Weaver
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Shipwright
      ...
      },
      {
         -- Food
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Fisher
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Hunter
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Gamekeeper
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Farmer
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Baker
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Brewer
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Master Brewer
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Innkeeper
      ...
      },
      {
         -- Mining
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Geologist
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Miner
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Chief Miner
               purpose = pgettext("barbarians_worker", "Works deep in the mines to obtain coal, iron, gold or granite.")
            }
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Master Miner
               purpose = pgettext("barbarians_worker", "Works deep in the mines to obtain coal, iron, gold or granite.")
            }
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Charcoal Burner
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Smelter
      ...
      },
      {
         -- Tools
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Blacksmith
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Master Blacksmith
               purpose = pgettext("barbarians_worker", "Produces weapons for soldiers and tools for workers.")
            }
         }
      },
      {
         -- Military
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Recruit
         ...
         },
         {
            ...
            preciousness = 5,
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Soldier
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Trainer
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Helmsmith
         ...
         },
         {
            ...
            helptexts = {
               -- TRANSLATORS: Helptext for a Barbarians worker: Scout
   ...
   immovables = {
      {
         name = "ashes",
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians immovable: Ashes
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians immovable: Destroyed Building
            purpose = _("The remains of a destroyed building.")
         }
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians immovable: Wheat field
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians resource indicator: No resources
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians resource indicator: Water
      ...
      },
      {
         ...
         helptexts = {
            purpose = {
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Coal, part 1
               _("Coal veins contain coal that can be dug up by coal mines."),
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Coal part 2
      ...
      },
      {
         ...
         helptexts = {
            purpose = {
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Iron, part 1
               _("Iron veins contain iron ore that can be dug up by iron mines."),
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Iron, part 2
      ...
      },
      {
         ...
         helptexts = {
            purpose = {
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Gold, part 1
               _("Gold veins contain gold ore that can be dug up by gold mines."),
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Gold, part 2
      ...
      },
      {
         ...
         helptexts = {
            purpose = {
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Stones, part 1
               _("Granite is a basic building material and can be dug up by a granite mine."),
               -- TRANSLATORS: Helptext for a Barbarians resource indicator: Stones, part 2
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for a Barbarians immovable: Ship Under Construction
            purpose = _("A ship is being constructed at this site.")
         }
      },
      -- non Barbarians immovables used by the woodcutter
      {
         name = "deadtree7",
         helptexts = {
   ...
   buildings = {
      -- Warehouses
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians warehouse: Headquarters
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians warehouse: Headquarters
            lore_author = pgettext("barbarians_building", "Ballad ‘The Battle of Kal’mavrath’ by Hakhor the Bard"),
            -- TRANSLATORS: Purpose helptext for a Barbarians warehouse: Headquarters
            purpose = pgettext("barbarians_building", "Accommodation for your people. Also stores your wares and tools."),
            -- TRANSLATORS: Note helptext for a Barbarians warehouse: Headquarters
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians warehouse: Warehouse
            lore = pgettext("barbarians_building", "‘Who still owns a warehouse is not yet defeated!’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians warehouse: Warehouse
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians warehouse: Warehouse
      ...
      },
      {
         ...
         helptexts = {
            ...
            -- TRANSLATORS: Note helptext for an Barbarians warehouse: Port
      ...
      -- Small
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Quarry
            lore = pgettext("barbarians_building", "‘We open up roads and make houses from mountains.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Quarry
            lore_author = pgettext("barbarians_building", "Slogan of the stonemasons’ guild"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Quarry
            purpose = pgettext("barbarians_building", "Cuts raw pieces of granite out of rocks in the vicinity."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Quarry
            note = pgettext("barbarians_building", "The quarry needs rocks to cut within the work area."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Quarry
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Lumberjack_s Hut
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Lumberjack_s Hut
            lore_author = pgettext("barbarians_building", "Krumta, carpenter of Chat’Karuth"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Lumberjack_s Hut
            purpose = pgettext("building", "Fells trees in the surrounding area and processes them into logs."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Lumberjack_s Hut
            note = pgettext("barbarians_building", "The lumberjack’s hut needs trees to fell within the work area."),
            performance = {
               -- TRANSLATORS: Performance helptext for a Barbarians production site: Lumberjack_s Hut
      ...
      },
      {
         ...
         helptexts = {
            ...
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Ranger's Hut
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Ranger's Hut
            lore_author = pgettext("barbarians_building", "Chat’Karuth in a conversation with a Ranger"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Ranger's Hut
            purpose = pgettext("building", "Plants trees in the surrounding area."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Ranger's Hut
            note = pgettext("barbarians_building", "The ranger’s hut needs free space within the work area to plant the trees."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Ranger's Hut
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Fisher's Hut
            lore = pgettext("barbarians_building", "‘What do you mean, my fish ain’t fresh?!’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Fisher's Hut
            lore_author = pgettext("barbarians_building", "Frequent response of a Barbarians fisherman,<br>often followed by an enjoyable brawl"),
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Hunter's Hut
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Hunter's Hut
            lore_author = pgettext("barbarians_building", "‘The Art of Hunting’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Hunter's Hut
            purpose = pgettext("building", "Hunts animals to produce meat."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Hunter's Hut
            note = pgettext("barbarians_building", "The hunter’s hut needs animals to hunt within the work area."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Hunter's Hut
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Gamekeeper's Hut
            lore = pgettext("barbarians_building", "‘He loves the animals and to breed them<br>as we love to cook and eat them.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Gamekeeper's Hut
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Well
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Well
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Well
            purpose = pgettext("building", "Draws water out of the deep."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Well
      ...
      },
      {
         ...
         helptexts = {
            ...
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Scout's Hut
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Scout's Hut
            lore_author = pgettext("barbarians_building", "Chat’Karuth<br>at the oath taking ceremony of the first scout troupe"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Scout's Hut
      ...
      -- Medium
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Wood Hardener
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Wood Hardener
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Wood Hardener
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Reed Yard
            lore = pgettext("barbarians_building", "‘We grow roofs’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Reed Yard
            lore_author = pgettext("barbarians_building", "Slogan of the Guild of Gardeners"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Reed Yard
            purpose = pgettext("barbarians_building", "Cultivates reed that serves two different purposes for the Barbarians tribe."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Reed Yard
            ...
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Reed Yard
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Lime Kiln
            lore = pgettext("barbarians_building", "‘Forming new stone from old with fire and water.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Lime Kiln
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Lime Kiln
            ...
            -- TRANSLATORS: Note helptext for a Barbarians production site: Lime Kiln
            ...
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Lime Kiln
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Micro Brewery
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Micro Brewery
            lore_author = pgettext("barbarians_building", "Widespread toast among miners"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Micro Brewery
            ...
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Micro Brewery
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Brewery
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Brewery
            lore_author = pgettext("barbarians_building", "First verse of the drinking song ‘Way of the Barbarian’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Brewery
            purpose = pgettext("building", "Produces beer to keep the miners strong and happy."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Brewery
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Tavern
            lore = pgettext("barbarians_building", "‘Fresh from the countryside: Bread, fish or game to go.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Tavern
            lore_author = pgettext("barbarians_building", "Menu of the tavern ‘Ye Ol’ Bronze Axe’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Tavern
            purpose = pgettext("building", "Prepares rations to feed the scouts and miners."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Tavern
      ...
      },
      {
         name = "barbarians_inn",
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Inn
            lore = pgettext("barbarians_building", "‘Miner’s Delight: Pitta bread with fish or meat, comes with one beer.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Inn
            lore_author = pgettext("barbarians_building", "Chef’s recommendation in ‘The Singing Master Miner’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Inn
            ...
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Inn
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Big Inn
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Big Inn
            lore_author = pgettext("barbarians_building", "Menu of ‘The Laughing Barbarian’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Big Inn
            purpose = pgettext("barbarians_building", "Prepares rations for scouts and rations, snacks and meals to feed all miners."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Big Inn
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Charcoal Kiln
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Charcoal Kiln
            lore_author = pgettext("barbarians_building", "Song of the charcoal burners"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Charcoal Kiln
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Smelting Works
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Smelting Works
            lore_author = pgettext("barbarians_building", "Chat’Karuth<br>at the 5ᵗʰ conference of master craftsmen"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Smelting Works
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Metal Workshop
            lore = pgettext("barbarians_building", "‘We make it work!’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Metal Workshop
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Metal Workshop
            purpose = pgettext("building", "Forges all the tools that your workers need."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Metal Workshop
            note = pgettext("barbarians_building", "The Barbarians metal workshop is the basic production site in a series of three buildings and creates all the tools that Barbarians need. The others are for weapons."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Metal Workshop
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Warmill
            lore = pgettext("barbarians_building", "‘A new warrior’s ax brings forth the best in its wielder – or the worst in its maker.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Warmill
            lore_author = pgettext("barbarians_building", "An old Barbarians proverb<br> meaning that you need to take some risks sometimes."),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Warmill
            purpose = pgettext("barbarians_building", "Produces all the axes that the Barbarians use for warfare."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Warmill
            note = pgettext("barbarians_building", "The Barbarians war mill is their most advanced production site for weapons. As such you will need to enhance an ax workshop in order to get one."),
            performance = {
               -- TRANSLATORS: Performance helptext for a Barbarians production site: Warmill, part 1
               ...
               -- TRANSLATORS: Performance helptext for a Barbarians production site: Warmill, part 2
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Ax Workshop
            lore = pgettext("barbarians_building", "‘A new warrior’s ax brings forth the best in its wielder – or the worst in its maker.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Ax Workshop
            lore_author = pgettext("barbarians_building", "An old Barbarians proverb<br> meaning that you need to take some risks sometimes."),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Ax Workshop
            purpose = pgettext("barbarians_building", "Produces axes, sharp axes and broad axes."),
            -- TRANSLATORS: Note helptext for a Barbarians production site: Ax Workshop
            ...
            performance = {
               -- TRANSLATORS: Performance helptext for a Barbarians production site: Ax Workshop
               pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce each type of ax in about %s on average."):bformat(format_minutes_seconds(1, 1)),
               -- TRANSLATORS: Performance helptext for a Barbarians production site: Ax Workshop
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Barracks
            lore = pgettext("barbarians_building", "‘Don’t ask what your tribe can do for you, ask what you can do for your tribe!’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Barracks
            lore_author = pgettext("barbarians_building", "Famous Barbarians recruitment poster"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Barracks
            purpose = pgettext("barbarians_building", "Equips recruits and trains them as soldiers."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Barracks
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Farm
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Farm
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Helm Smithy
            lore = pgettext("barbarians_building", "‘The helmets forgéd by this smithy<br>Are widely known for looking pithy.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Helm Smithy
            lore_author = pgettext("barbarians_building", "Slogan of ‘Harrath’s Handsome Helmets’ in Al’thunran"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Helm Smithy
      ...
      -- Mines
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Granite Mine
            lore = pgettext("barbarians_building", "‘I can handle tons of granite, man, but no more of your vain prattle.’"),
            lore_author = {
               -- TRANSLATORS: Lore author helptext for a Barbarians production site: Granite Mine, part 1
               ...
               -- TRANSLATORS: Lore author helptext for a Barbarians production site: Granite Mine, part 2
            ...
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Granite Mine
            ...
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Granite Mine
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Iron Mine
            lore = pgettext("barbarians_building", "‘I look at my own pick wearing away day by day and I realize why my work is important.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Iron Mine
            lore_author = pgettext("barbarians_building", "Quote from an anonymous miner."),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Iron Mine
            purpose = pgettext("building", "Digs iron ore out of the ground in mountain terrain."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Iron Mine
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Deep Iron Mine
            lore = pgettext("barbarians_building", "‘I look at my own pick wearing away day by day and I realize why my work is important.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Deep Iron Mine
            lore_author = pgettext("barbarians_building", "Quote from an anonymous miner."),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Deep Iron Mine
            purpose = pgettext("building", "Digs iron ore out of the ground in mountain terrain."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Deep Iron Mine
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Deeper Iron Mine
            lore = pgettext("barbarians_building", "‘I look at my own pick wearing away day by day and I realize why my work is important.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Deeper Iron Mine
            lore_author = pgettext("barbarians_building", "Quote from an anonymous miner."),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Deeper Iron Mine
            purpose = pgettext("building", "Digs iron ore out of the ground in mountain terrain."),
            -- TRANSLATORS: Performance helptext for a Barbarians production site: Deeper Iron Mine
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Gold Mine
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Gold Mine
            lore_author = pgettext("barbarians_building", "Excerpt from ‘Our Treasures Underground’,<br> a traditional Barbarians song."),
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Deep Gold Mine
            lore = pgettext("barbarians_building", "‘Soft and supple.<br> And yet untouched by time and weather.<br> Rays of sun, wrought into eternity…’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Deep Gold Mine
            lore_author = pgettext("barbarians_building", "Excerpt from ‘Our Treasures Underground’,<br> a traditional Barbarians song."),
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Deeper Gold Mine
            lore = pgettext("barbarians_building", "‘Soft and supple.<br> And yet untouched by time and weather.<br> Rays of sun, wrought into eternity…’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Deeper Gold Mine
            lore_author = pgettext("barbarians_building", "Excerpt from ‘Our Treasures Underground’,<br> a traditional Barbarians song."),
      ...
      -- Training Sites
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians training site: Battle Arena
            lore = pgettext("barbarians_building", "‘No better friend you have in battle than the enemy’s blow that misses.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians training site: Battle Arena
            lore_author = pgettext("barbarians_building", "Said to originate from Neidhardt, the famous trainer."),
            purpose = {
               -- TRANSLATORS: Purpose helptext for a Barbarians training site: Battle Arena, part 1
               pgettext("barbarians_building", "Trains soldiers in ‘Evade’."),
               -- TRANSLATORS: Purpose helptext for a Barbarians training site: Battle Arena, part 2
            ...
            -- TRANSLATORS: Note helptext for a Barbarians training site: Battle Arena
            note = pgettext("barbarians_building", "Barbarians soldiers cannot be trained in ‘Defense’ and will remain at their initial level."),
            -- TRANSLATORS: Performance helptext for a Barbarians training site: Battle Arena
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians training site: Training Camp
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians training site: Training Camp
            lore_author = pgettext("barbarians_building", "Chief Chat’Karuth in a speech to his army."),
            purpose = {
               -- TRANSLATORS: Purpose helptext for a Barbarians training site: Training Camp, part 1
               pgettext("barbarians_building", "Trains soldiers in ‘Attack’ and in ‘Health’."),
               -- TRANSLATORS: Purpose helptext for a Barbarians training site: Training Camp, part 2
               pgettext("barbarians_building", "Equips the soldiers with all necessary weapons and armor parts.")
            },
            -- TRANSLATORS: Note helptext for a Barbarians building: Training Camp
            note = pgettext("barbarians_building", "Barbarians soldiers cannot be trained in ‘Defense’ and will remain at their initial level."),
            -- TRANSLATORS: Performance helptext for a Barbarians training site: Training Camp
      ...
      -- Military Sites
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians military site: Sentry
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians military site: Sentry
            lore_author = pgettext("barbarians_building", "Boldreth,<br>about his time as young soldier"),
            -- TRANSLATORS: Purpose helptext for a Barbarians military site: Sentry
            purpose = pgettext("barbarians_building", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a Barbarians military site: Sentry
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians military site: Barrier
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians military site: Barrier
            lore_author = pgettext("barbarians_building", "Ballad ‘The Battle of Kal’mavrath’ by Hakhor the Bard"),
            -- TRANSLATORS: Purpose helptext for a Barbarians military site: Barrier
            purpose = pgettext("barbarians_building", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a Barbarians military site: Barrier
            note = pgettext("barbarians_building", "If you’re low on soldiers to occupy new military sites, use the downward arrow button to decrease the capacity. You can also click on a soldier to send him away.")
         }
      },

      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians military site: Tower
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians military site: Tower
            lore_author = pgettext("barbarians_building", "Ballad ‘The Battle of Kal’mavrath’ by Hakhor the Bard"),
            -- TRANSLATORS: Purpose helptext for a Barbarians military site: Tower
            purpose = pgettext("barbarians_building", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a Barbarians military site: Tower
            note = pgettext("barbarians_building", "If you’re low on soldiers to occupy new military sites, use the downward arrow button to decrease the capacity. You can also click on a soldier to send him away.")
         }
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians military site: Fortress
            lore = pgettext("barbarians_building", "‘This stronghold made from blackwood and stones will be a hard nut to crack for them.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians military site: Fortress
            lore_author = pgettext("barbarians_building", "Berthron,<br>chief military adviser of Chat’Karuth"),
            -- TRANSLATORS: Purpose helptext for a Barbarians military site: Fortress
            purpose = pgettext("barbarians_building", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a Barbarians military site: Fortress
            note = pgettext("barbarians_building", "If you’re low on soldiers to occupy new military sites, use the downward arrow button to decrease the capacity. You can also click on a soldier to send him away.")
         }
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians military site: Citadel
            lore = pgettext("barbarians_building", "‘The Citadel of Adlen surely is the finest masterpiece of Barbarians craftsmanship. Nothing as strong and big and beautiful has ever been built in such a short time.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians military site: Citadel
            lore_author = pgettext("barbarians_building", "Colintan, chief planner of the Citadel of Adlen,<br>at its opening ceremony"),
            -- TRANSLATORS: Purpose helptext for a Barbarians military site: Citadel
            purpose = pgettext("barbarians_building", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a Barbarians military site: Citadel
            note = pgettext("barbarians_building", "If you’re low on soldiers to occupy new military sites, use the downward arrow button to decrease the capacity. You can also click on a soldier to send him away.")
         }
      },
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Shipyard
            ...
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Shipyard
            lore_author = pgettext("barbarians_building", "Captain Thanlas the Elder,<br>Explorer"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Shipyard
      ...
      },
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians production site: Weaving Mill
            lore = pgettext("barbarians_building", [[‘Fine cloth and jewelry mean nothing to a true Barbarians.<br>]] ..
                                          [[But a noble sail in the wind will please his eyes.’]]),
            -- TRANSLATORS: Lore author helptext for a Barbarians production site: Weaving Mill
            lore_author = pgettext("barbarians_building", "Khantarakh, ‘The Modern Barbarians Economy’,<br>9ᵗʰ cowhide ‘Seafaring and Conquest’"),
            -- TRANSLATORS: Purpose helptext for a Barbarians production site: Weaving Mill
      ...
      -- Partially Finished Buildings - these are the same 2 buildings for all tribes
      {
         ...
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians building: Construction Site
            lore = pgettext("building", "‘Don’t swear at the builder who is short of building materials.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians building: Construction Site
            lore_author = pgettext("building", "Proverb widely used for impossible tasks of any kind"),
            -- TRANSLATORS: Purpose helptext for a Barbarians building: Construction Site
      ...
      },
      {
         name = "dismantlesite",
         helptexts = {
            -- TRANSLATORS: Lore helptext for a Barbarians building: Dismantle Site
            lore = pgettext("building", "‘New paths will appear when you are willing to tear down the old.’"),
            -- TRANSLATORS: Lore author helptext for a Barbarians building: Dismantle Site
            lore_author = pgettext("building", "Proverb"),
            -- TRANSLATORS: Purpose helptext for a Barbarians building: Dismantle Site
   ...
   warehouse_names = {
      -- TRANSLATORS: This Barbarians warehouse is inspired by a Norwegian town name.
      ...
      -- TRANSLATORS: This Barbarians warehouse is named after a barbarian town.
   ...
   -- TRANSLATORS: Productivity label on a Barbarians building if there is 1 worker missing
   productionsite_worker_missing = pgettext("barbarians", "Worker missing"),
   -- TRANSLATORS: Productivity label on a Barbarians building if there is 1 worker coming
   productionsite_worker_coming = pgettext("barbarians", "Worker is coming"),
   -- TRANSLATORS: Productivity label on a Barbarians building if there is more than 1 worker missing. If you need plural forms here, please let us know.
   productionsite_workers_missing = pgettext("barbarians", "Workers missing"),
   -- TRANSLATORS: Productivity label on a Barbarians building if there is more than 1 worker coming. If you need plural forms here, please let us know.
   productionsite_workers_coming = pgettext("barbarians", "Workers are coming"),
   -- TRANSLATORS: Productivity label on a Barbarians building if there is 1 experienced worker missing
   productionsite_experienced_worker_missing = pgettext("barbarians", "Expert missing"),
   -- TRANSLATORS: Productivity label on a Barbarians building if there is more than 1 experienced worker missing. If you need plural forms here, please let us know.
   ...
   -- TRANSLATORS: %1% is the number of Barbarians soldiers the plural refers to. %2% is the maximum number of soldier slots in the building.
   UNUSED_soldier_0 = npgettext("barbarians_soldier", "%1% soldier (+%2%)", "%1% soldiers (+%2%)", 0),
   -- TRANSLATORS: Number of Barbarians soldiers stationed at a militarysite.
   UNUSED_soldier_1 = npgettext("barbarians_soldier", "%1% soldier", "%1% soldiers", 0),
   -- TRANSLATORS: %1% is the number of Barbarians soldiers the plural refers to. %2% are currently open soldier slots in the building. %3% is the maximum number of soldier slots in the building
   UNUSED_soldier_2 = npgettext("barbarians_soldier", "%1%(+%2%) soldier (+%3%)", "%1%(+%2%) soldiers (+%3%)", 0),
   -- TRANSLATORS: %1% is the number of Barbarians soldiers the plural refers to. %2% are currently open soldier slots in the building.
