   ...
   buildings = {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The hunter-gatherer pauses %1% before going to work again."):bformat(format_seconds(34))
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The liana cutter rests %1% before going to work again."):bformat(format_seconds(30))
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The scout pauses %1% before going to work again."):bformat(format_seconds(30))
         }
      },
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The furnace can produce one gold ingot in %1% on average if the supply is steady."):bformat(format_seconds(72))
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The charcoal kiln needs %1% on average to produce one lump of coal."):bformat(format_seconds(121))
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The chocolate brewery needs %1% on average to brew one mug of chocolate."):bformat(format_seconds(60))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The food preserver can produce one ration in %1% on average if the supply is steady."):bformat(format_seconds(17))
         }
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The initiation site needs %1% on average to recruit one soldier."):bformat(format_seconds(30))
         }
      },
      {
      ...
      -- Mines
      {
         ...
         helptexts = {
            ...
            performance = pgettext("amazons_building", "The stone mine can produce one slab of granite in %1% on average if the supply with rations is steady and the mine is not worn out."):bformat(format_seconds(32))
         }
      },
      {
