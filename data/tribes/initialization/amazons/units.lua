   ...
   buildings = {
      ...
      },
      {
         ...
         helptexts = {
            ...
            note = pgettext("amazons_building", "Similar to the Headquarters a Port can be attacked and destroyed by an enemy. It is recommendable to store soldiers in there to defend it.")
         }
      },
