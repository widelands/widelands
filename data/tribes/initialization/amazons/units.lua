...
wl.Descriptions():new_tribe {
   ...
   soldier_1 = npgettext("amazons_soldier", "%1% soldier (+%2%)", "%1% soldiers (+%2%)", 0)
   -- TRANSLATORS: Number of Frisian soldiers stationed at a militarysite.
   soldier_2 = npgettext("amazons_soldier", "%1% soldier", "%1% soldiers", 0)
   ...
   soldier_3 = npgettext("amazons_soldier", "%1%(+%2%) soldier (+%3%)", "%1%(+%2%) soldiers (+%3%)", 0)
   -- TRANSLATORS: %1% is the number of Frisian soldiers the plural refers to. %2% are currently open soldier slots in the building.
   soldier_4 = npgettext("amazons_soldier", "%1%(+%2%) soldier", "%1%(+%2%) soldiers", 0)
