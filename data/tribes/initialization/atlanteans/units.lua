...
--                pgettext("barbarians_building", "If all needed wares are delivered in time, this building can produce each type of ax in about %1% on average."):bformat(format_seconds(57)),
