...
return {
   wares = {
      atlanteans_bread = {
         -- TRANSLATORS: Helptext for a ware: Bread
         pgettext(warectxt, "This tasty bread is made in bakeries out of cornmeal, blackroot flour and water. It is appreciated as basic food by miners, scouts and soldiers in training sites (labyrinth and dungeon).")
      },
      blackroot = {
         -- TRANSLATORS: Helptext for a ware: Blackroot
         pgettext(warectxt, "Blackroots are a special kind of root produced at blackroot farms and processed in mills. The Atlanteans like their strong taste and use their flour for making bread.")
      },
      blackroot_flour = {
         -- TRANSLATORS: Helptext for a ware: Blackroot Flour
         pgettext(warectxt, "Blackroot Flour is produced in mills out of blackroots. It is used in bakeries to make a tasty bread.")
      },
      bread_paddle = {
         -- TRANSLATORS: Helptext for a ware: Bread Paddle
         pgettext(warectxt, "The bread paddle is the tool of the baker, each baker needs one."),
      ...
      buckets = {
         ...
         pgettext(warectxt, "Big buckets for the fish breeder – produced by the toolsmith.")
      },
      coal = {
      ...
      corn = {
         ...
         pgettext(warectxt, "This corn is processed in the mill into fine cornmeal that every Atlantean baker needs for a good bread. Also horse and spider farms need to be provided with corn.")
      },
      cornmeal = {
         -- TRANSLATORS: Helptext for a ware: Cornmeal
         pgettext(warectxt, "Cornmeal is produced in a mill out of corn and is one of three parts of the Atlantean bread produced in bakeries.")
      },
      diamond = {
         -- TRANSLATORS: Helptext for a ware: Diamond
         pgettext(warectxt, "These wonderful diamonds are used to build some exclusive buildings. They are mined in a crystal mine.")
      },
      fire_tongs = {
      ...
      fish = {
         ...
         pgettext(warectxt, "Fish is one of the biggest food resources of the Atlanteans. It has to be smoked in a smokery before being delivered to mines, training sites and scouts.")
      },
      fishing_net = {
         -- TRANSLATORS: Helptext for a ware: Fishing Net
         pgettext(warectxt, "The fishing net is used by the fisher and produced by the toolsmith.")
      },
      gold = {
      ...
      gold_thread = {
         ...
         pgettext(warectxt, "This thread, made of gold by the gold spinning mill, is used for weaving the exclusive golden tabard in the weaving mill.")
      },
      granite = {
      ...
      hook_pole = {
         ...
         pgettext(warectxt, "This hook pole is used by the smoker to suspend all the meat and fish from the top of the smokery. It is created by the toolsmith.")
      },
      hunting_bow = {
         -- TRANSLATORS: Helptext for a ware: Hunting Bow
         pgettext(warectxt, "This bow is used by the Atlantean hunter. It is produced by the toolsmith.")
      },
      iron = {
      ...
      milking_tongs = {
         ...
         pgettext(warectxt, "Milking tongs are used by the spider breeder to milk the spiders. They are produced by the toolsmith.")
      },
      pick = {
         -- TRANSLATORS: Helptext for a ware: Pick
         pgettext(warectxt, "Picks are used by stonecutters and miners. They are produced by the toolsmith.")
      },
      planks = {
      ...
      quartz = {
         ...
         pgettext(warectxt, "These transparent quartz gems are used to build some exclusive buildings. They are produced in a crystal mine.")
      },
      saw = {
         -- TRANSLATORS: Helptext for a ware: Saw
         pgettext(warectxt, "The saw is needed by the sawyer, the woodcutter and the toolsmith. It is produced by the toolsmith.")
      },
      scythe = {
      ...
      shield_advanced = {
         ...
         pgettext(warectxt, "These advanced shields are used by the best soldiers of the Atlanteans. They are produced in the armor smithy and used in the labyrinth – together with food – to train soldiers from defense level 1 to level 2.")
      },
      shield_steel = {
         -- TRANSLATORS: Helptext for a ware: Steel Shield
         pgettext(warectxt, "This steel shield is produced in the armor smithy and used in the labyrinth – together with food – to train soldiers from defense level 0 to level 1.")
      },
      shovel = {
      ...
      smoked_fish = {
         ...
         pgettext(warectxt, "As no Atlantean likes raw fish, smoking it in a smokery is the most common way to make it edible.")
      },
      smoked_meat = {
         -- TRANSLATORS: Helptext for a ware: Smoked Meat
         pgettext(warectxt, "Smoked meat is made out of meat in a smokery. It is delivered to the mines and training sites (labyrinth and dungeon) where the miners and soldiers prepare a nutritious lunch for themselves.")
      },
      spider_silk = {
         -- TRANSLATORS: Helptext for a ware: Spider Silk
         pgettext(warectxt, "Spider silk is produced by spiders, which are bred by spider farms. It is processed into spidercloth in a weaving mill.")
      },
      spidercloth = {
         -- TRANSLATORS: Helptext for a ware: Spidercloth
         pgettext(warectxt, "Spidercloth is made out of spider silk in a weaving mill. It is used in the toolsmithy and the shipyard. Also some higher developed buildings need spidercloth for their construction.")
      },
      tabard = {
         -- TRANSLATORS: Helptext for a ware: Tabard
         pgettext(warectxt, "A tabard and a light trident are the basic equipment for young soldiers. Tabards are produced in the weaving mill.")
      },
      tabard_golden = {
         -- TRANSLATORS: Helptext for a ware: Golden Tabard
         pgettext(warectxt, "Golden tabards are produced in Atlantean weaving mills out of gold thread. They are used in the labyrinth – together with food – to train soldiers from health level 0 to level 1.")
      },
      trident_double = {
         -- TRANSLATORS: Helptext for a ware: Double Trident
         pgettext(warectxt, "The double trident is one of the best tridents produced by the Atlantean weapon smithy. It is used in a dungeon – together with food – to train soldiers from attack level 2 to level 3.")
      },
      trident_heavy_double = {
         -- TRANSLATORS: Helptext for a ware: Heavy Double Trident
         pgettext(warectxt, "This is the most dangerous weapon of the Atlantean military. Only the best of the best soldiers may use it. It is produced in the weapon smithy and used in the dungeon – together with food – to train soldiers from attack level 3 to level 4.")
      },
      trident_light = {
         -- TRANSLATORS: Helptext for a ware: Light Trident
         pgettext(warectxt, "This is the basic weapon of the Atlantean soldiers. Together with a tabard, it makes up the equipment of young soldiers. Light tridents are produced in the weapon smithy as are all other tridents.")
      },
      trident_long = {
         -- TRANSLATORS: Helptext for a ware: Long Trident
         pgettext(warectxt, "The long trident is the first trident in the training of soldiers. It is produced in the weapon smithy and used in the dungeon – together with food – to train soldiers from attack level 0 to level 1.")
      },
      trident_steel = {
         -- TRANSLATORS: Helptext for a ware: Steel Trident
         pgettext(warectxt, "This is the medium trident. It is produced in the weapon smithy and used by advanced soldiers in the dungeon – together with food – to train from attack level 1 to level 2.")
      },
      water = {
