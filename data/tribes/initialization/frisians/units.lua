...
wl.Descriptions():new_tribe {
   ...
   immovables = {
      ...
      -- The tribe would work without defining these here, but this way we add them to the encyclopedia.
      {
         ...
         helptexts = {
            -- TRANSLATORS: Helptext for an empire/Barbarians immovable usable by frisians: Wheat field
            purpose = _("This field is flowering. Honey can be produced from it by a beekeeper.")
         }
      },
      {
   ...
   buildings = {
      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = pgettext("frisians_building", "If all needed wares are delivered in time, this building can produce one short sword in %1$s on average, one long sword in %2$s on average and one helmet in %3$s on average."):bformat(format_minutes_seconds(4, 14), format_minutes_seconds(2, 7), format_minutes_seconds(4, 14))
         }
      },
      {
