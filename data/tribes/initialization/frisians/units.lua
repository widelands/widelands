...
wl.Descriptions():new_tribe {
   ...
   productionsite_experienced_worker_missing = pgettext("frisians", "Master missing"),
   ...
   productionsite_experienced_workers_missing = pgettext("frisians", "Masters missing"),
