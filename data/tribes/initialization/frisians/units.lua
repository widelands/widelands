   ...
   buildings = {
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Your workers and soldiers will find shelter here. Also stores your wares and tools.")
         }
      },
      {
         name = "frisians_port",
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Breeds fish as food for soldiers and miners."),
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Produces basic weapons and helmets for the soldiers.")
         }
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Produces advanced weapons and golden helmets for the soldiers.")
         }
      },
      {
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Smokes fish and meat using logs. Only smoked meat and fish are good enough to be eaten by miners and soldiers."),
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Bakes bread out of barley and water to feed miners and soldiers."),
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Bakes honey bread out of barley, water and honey to feed miners in deep mines and soldiers in advanced training.")
         }
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Brews beer for miners and soldier training."),
      ...
      },
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Brews beer out of barley and water. It also brews mead, which is beer refined with honey. Mead is consumed by experienced soldiers.")
         }
      },
      {
      ...
      -- Military Sites
      {
         ...
         helptexts = {
            ...
            purpose = pgettext("building_frisians", "Garrisons soldiers to expand your territory."),
            -- TRANSLATORS: Note helptext for a frisian military site: Wooden Tower
            note = pgettext("building_frisians", "If you’re low on soldiers to occupy new military sites, use the downward arrow button to decrease the capacity. You can also click on a soldier to send him away.")
         }
      },
      {
