      ...
      },
      {
         ...
         helptexts = {
            ...
            performance = {
               ...
               pgettext("frisians_building", "The farmer sows and harvests one sheaf of barley between %1$s and %2$s, depending on how far he has to walk."):bformat(format_seconds(51), format_minutes_seconds(1, 2)),
