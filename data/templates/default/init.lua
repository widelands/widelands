...
return {
   ...
   windows = {
      fsmenu = {
         ...
         corner_bottom_left   = "fsmenu/windows/corner_bottom_left.png",
         corner_bottom_right  = "fsmenu/windows/corner_bottom_right.png",
         corner_top_left      = "fsmenu/windows/corner_top_left.png",
         corner_top_right     = "fsmenu/windows/corner_top_right.png",
         corner_minimal_left  = "fsmenu/windows/corner_minimal_left.png",
         corner_minimal_right = "fsmenu/windows/corner_minimal_right.png",
      ...
      wui = {
         ...
         corner_bottom_left   = "wui/windows/corner_bottom_left.png",
         corner_bottom_right  = "wui/windows/corner_bottom_right.png",
         corner_top_left      = "wui/windows/corner_top_left.png",
         corner_top_right     = "wui/windows/corner_top_right.png",
         corner_minimal_left  = "wui/windows/corner_minimal_left.png",
         corner_minimal_right = "wui/windows/corner_minimal_right.png",
