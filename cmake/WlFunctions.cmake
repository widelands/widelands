...
macro(_common_compile_tasks)
  ...
  if(ARG_USES_SDL2)
    if (OPTION_BUILD_WINSTATIC)
      target_link_libraries(${NAME} ${TARGET_LINK_FLAGS} SDL2::Main ${SDL_EXTRA_LIBS} intl iconv dinput8 shell32 setupapi advapi32 uuid version oleaut32 ole32 imm32 winmm gdi32 user32 ${BROTLI})
    else()
  ...
  if(ARG_USES_SDL2_TTF)
    if (OPTION_BUILD_WINSTATIC)
      target_link_libraries(${NAME} ${TARGET_LINK_FLAGS} SDL2::TTF freetype bz2 graphite2 usp10 dwrite harfbuzz freetype rpcrt4)
    else()
