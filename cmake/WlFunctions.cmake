...
macro(_common_compile_tasks)
  ...
  if(ARG_USES_ZLIB AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
  ...
  if(ARG_USES_OPENGL)
    ...
    if(NOT ${CMAKE_VERSION} VERSION_LESS 3.9.0 AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
      target_link_libraries(${NAME} OpenGL::GL)
    endif()
  endif()

  if(ARG_USES_PNG AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
    target_link_libraries(${NAME} PNG::PNG)
  endif()

  if(ARG_USES_SDL2 AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
    target_link_libraries(${NAME} ${TARGET_LINK_FLAGS} SDL2::Main ${SDL_STATIC_LIBS})
  endif()

  if(ARG_USES_SDL2_MIXER AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
    target_link_libraries(${NAME} ${TARGET_LINK_FLAGS} SDL2::Mixer ${SDL_MIXER_STATIC_LIBS})
  endif()

  if(ARG_USES_SDL2_IMAGE AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
    target_link_libraries(${NAME} ${TARGET_LINK_FLAGS} SDL2::Image ${SDL_IMG_STATIC_LIBS})
  endif()

  if(ARG_USES_SDL2_TTF AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten")
