...
macro(_common_compile_tasks)
  ...
  if(ARG_USES_SDL2_MIXER)
    wl_include_system_directories(${NAME} ${SDL2MIXER_INCLUDE_DIRS})
    target_link_libraries(${NAME} ${SDL2MIXER_LIBRARIES})
  endif()

  if(ARG_USES_SDL2_IMAGE)
    wl_include_system_directories(${NAME} ${SDL2IMAGE_INCLUDE_DIRS})
    target_link_libraries(${NAME} ${SDL2IMAGE_LIBRARIES})
  endif()

  if(ARG_USES_SDL2_TTF)
    wl_include_system_directories(${NAME} ${SDL2TTF_INCLUDE_DIRS})
    target_link_libraries(${NAME} ${SDL2TTF_LIBRARIES})
  endif()
